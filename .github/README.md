...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.572.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.572.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gzbKOiSNgpwzAP3bhF8iH7sJ+C2cQTZh+rLk4higrSzh0Z+gAMbTzf5VtKGZpR5I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.572.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.572.0/index.min.mjs": "sha384-gzbKOiSNgpwzAP3bhF8iH7sJ+C2cQTZh+rLk4higrSzh0Z+gAMbTzf5VtKGZpR5I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.572.0/LICENSE
```

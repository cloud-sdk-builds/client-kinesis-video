...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+MBQDSD4i5sTqkyN/04NBbHVKXR12DjU0KmCtCv+dNvn86VU4Z1rxwgQ4moQrVAc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.985.0/index.min.mjs": "sha384-+MBQDSD4i5sTqkyN/04NBbHVKXR12DjU0KmCtCv+dNvn86VU4Z1rxwgQ4moQrVAc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.985.0/LICENSE
```

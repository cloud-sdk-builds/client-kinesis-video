...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.216.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.216.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EISo18Wf7S2VytX6Z9sARoGTLLxJeiq+EfDKDGZ0arlE6ywbgcUm7IGSiKZFXMWf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.216.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.216.0/index.min.mjs": "sha384-EISo18Wf7S2VytX6Z9sARoGTLLxJeiq+EfDKDGZ0arlE6ywbgcUm7IGSiKZFXMWf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.216.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.429.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.429.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pKkdOP0VKgmXvgrIZsymtOb2Pe3NCLqKV0EYOmXv4uLUnt8b1hVQzZkiCPcWAmmd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.429.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.429.0/index.min.mjs": "sha384-pKkdOP0VKgmXvgrIZsymtOb2Pe3NCLqKV0EYOmXv4uLUnt8b1hVQzZkiCPcWAmmd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.429.0/LICENSE
```

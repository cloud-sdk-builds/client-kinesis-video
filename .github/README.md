...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.427.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.427.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uDyZT29wPyAFCvjiAKaD5UGNwbLMeKrwGMM0b8bvyExJJ4l4CrXpt8xg+JQlTxdw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.427.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.427.0/index.min.mjs": "sha384-uDyZT29wPyAFCvjiAKaD5UGNwbLMeKrwGMM0b8bvyExJJ4l4CrXpt8xg+JQlTxdw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.427.0/LICENSE
```

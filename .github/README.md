...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.5.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.5.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xw1MgaX9XKKuG4/fYW9ze2Bzn77oHs6rXLL6hsSHxXQ+k2QdmjTNghevALgbZib+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.5.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.5.0/index.min.mjs": "sha384-Xw1MgaX9XKKuG4/fYW9ze2Bzn77oHs6rXLL6hsSHxXQ+k2QdmjTNghevALgbZib+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.5.0/LICENSE
```

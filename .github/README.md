...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.620.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.620.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E3oDehq/pq2tTyNV/2YU8FphngdgrTUJkdV+wgnYuwe7DMY8xlg7BjxxEnTWXhL/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.620.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.620.0/index.min.mjs": "sha384-E3oDehq/pq2tTyNV/2YU8FphngdgrTUJkdV+wgnYuwe7DMY8xlg7BjxxEnTWXhL/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.620.0/LICENSE
```

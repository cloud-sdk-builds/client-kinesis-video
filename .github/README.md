...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.154.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.154.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YVTj+t2cYplLe+DmE3W0CzQArkNAAGy6dX0eHvjo+hIyHtyOs4aC9qRndmPcKVBT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.154.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.154.0/index.min.mjs": "sha384-YVTj+t2cYplLe+DmE3W0CzQArkNAAGy6dX0eHvjo+hIyHtyOs4aC9qRndmPcKVBT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.154.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rd6dj8H1PYOxdUg9ny9lI4z7+IBwvhp1VCVKjE8SlaU6zbPWxFRqNJ57S+7Qjhsi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.241.0/index.min.mjs": "sha384-Rd6dj8H1PYOxdUg9ny9lI4z7+IBwvhp1VCVKjE8SlaU6zbPWxFRqNJ57S+7Qjhsi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.241.0/LICENSE
```

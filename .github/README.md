...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n9A/0t5ocAYyOxlAK5Rt+dlFZx1C2lJTpn4mWvFwdOj8V+Ko+ZTxXWsdE2vRhF2R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.201.0/index.min.mjs": "sha384-n9A/0t5ocAYyOxlAK5Rt+dlFZx1C2lJTpn4mWvFwdOj8V+Ko+ZTxXWsdE2vRhF2R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.201.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.431.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.431.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fHW5+LwaQik5zGCJef4OQG1v59/CSusKZa/SDIe4nm0juknL+imP80VlE6P6HBym
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.431.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.431.0/index.min.mjs": "sha384-fHW5+LwaQik5zGCJef4OQG1v59/CSusKZa/SDIe4nm0juknL+imP80VlE6P6HBym"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.431.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.267.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.267.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mj1UqRgkGFsZfeC04g3sDJ7f3NMsxffFY7t+ZeWfDfkKqkRBNLjTi9e6p7GQEXGn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.267.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.267.0/index.min.mjs": "sha384-mj1UqRgkGFsZfeC04g3sDJ7f3NMsxffFY7t+ZeWfDfkKqkRBNLjTi9e6p7GQEXGn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.267.0/LICENSE
```

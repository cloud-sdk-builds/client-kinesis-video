...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.817.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.817.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R6/uy/7xbURsHOzLt1ahyj/7NpBJiodtsen3Dkz+m31Mz7x0bzyCIUBw6/vAJvxD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.817.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.817.0/index.min.mjs": "sha384-R6/uy/7xbURsHOzLt1ahyj/7NpBJiodtsen3Dkz+m31Mz7x0bzyCIUBw6/vAJvxD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.817.0/LICENSE
```

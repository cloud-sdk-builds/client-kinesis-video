...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.669.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.669.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NF7QvYJybnthx4A+0htCrpjS+9c7lB7UrSpn8pk7zskWPEOIhpaOJEtmwQ7yxjgl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.669.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.669.0/index.min.mjs": "sha384-NF7QvYJybnthx4A+0htCrpjS+9c7lB7UrSpn8pk7zskWPEOIhpaOJEtmwQ7yxjgl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.669.0/LICENSE
```

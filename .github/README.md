...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.165.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.165.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jyTOOuIdD0UY8g3h7fw2Xzjv1UwGKD7xa0mU+l/oOmZiZOTEKhQLoG+LckElxOGs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.165.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.165.0/index.min.mjs": "sha384-jyTOOuIdD0UY8g3h7fw2Xzjv1UwGKD7xa0mU+l/oOmZiZOTEKhQLoG+LckElxOGs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.165.0/LICENSE
```

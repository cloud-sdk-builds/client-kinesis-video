...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.27.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.27.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o4u1GOVDzKnYhLWs1eFMYNbxfLFnpCH1JBdxnXTEU0M2G1ugdETuUvSCXaC5jrel
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.27.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.27.0/index.min.mjs": "sha384-o4u1GOVDzKnYhLWs1eFMYNbxfLFnpCH1JBdxnXTEU0M2G1ugdETuUvSCXaC5jrel"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.27.0/LICENSE
```

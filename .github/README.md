...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.623.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.623.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-He+rX80a2gGXGBHZkM9mXKbLFbY4DSakk4N58If7ZK9aJJ5+31LVubmdK0VgAKXV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.623.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.623.0/index.min.mjs": "sha384-He+rX80a2gGXGBHZkM9mXKbLFbY4DSakk4N58If7ZK9aJJ5+31LVubmdK0VgAKXV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.623.0/LICENSE
```

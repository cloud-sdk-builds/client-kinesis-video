...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.938.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.938.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mvUoXyjIvzStlkTFLmnRbtune3R7Wkf+9CshN+z1fBtVCA89VqxLcwGdxDJSUdaW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.938.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.938.0/index.min.mjs": "sha384-mvUoXyjIvzStlkTFLmnRbtune3R7Wkf+9CshN+z1fBtVCA89VqxLcwGdxDJSUdaW"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.938.0`)
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.938.0/LICENSE
```

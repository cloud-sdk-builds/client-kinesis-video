...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R8c6vFtyxCE+FMLDwlOn/ZK1XiJ6LdFOWCWd0UPAjtZ/tajVOHyifSlGxBv6C/cR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.738.0/index.min.mjs": "sha384-R8c6vFtyxCE+FMLDwlOn/ZK1XiJ6LdFOWCWd0UPAjtZ/tajVOHyifSlGxBv6C/cR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.738.0/LICENSE
```

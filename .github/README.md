...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.186.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.186.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EpsN+C7JjqWJX77JH5mckqjTrhNSZ4+edrpTz5bd3aNuto/e19ABt87PfDfksXmy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.186.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.186.0/index.min.mjs": "sha384-EpsN+C7JjqWJX77JH5mckqjTrhNSZ4+edrpTz5bd3aNuto/e19ABt87PfDfksXmy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.186.0/LICENSE
```

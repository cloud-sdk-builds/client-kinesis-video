...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.377.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.377.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LtHJBOPgI2A/PCXCe/VItgj9/QK8q3JM5m7s1PeKN3FpQZjqlKurpW+6YPr7ioXC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.377.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.377.0/index.min.mjs": "sha384-LtHJBOPgI2A/PCXCe/VItgj9/QK8q3JM5m7s1PeKN3FpQZjqlKurpW+6YPr7ioXC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.377.0/LICENSE
```

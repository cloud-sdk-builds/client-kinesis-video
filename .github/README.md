...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.338.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.338.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IT7AV0D5F0aoC250dnVv8UhspQy5jF2ZiVpPmZyMDgmwDRLd+py9GjJSaFavxlKL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.338.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.338.0/index.min.mjs": "sha384-IT7AV0D5F0aoC250dnVv8UhspQy5jF2ZiVpPmZyMDgmwDRLd+py9GjJSaFavxlKL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.338.0/LICENSE
```

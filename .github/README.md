...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-W1Xnof228is6dYBgCyL1cTvcP+USiehpWJe8XZHnzcXCUPIogB+kfMOCssz5hEi1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.315.0/index.min.mjs": "sha384-W1Xnof228is6dYBgCyL1cTvcP+USiehpWJe8XZHnzcXCUPIogB+kfMOCssz5hEi1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.315.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.569.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.569.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xknuGvOJkId3eOCMSafXM+2oTwTLbF8Ge04yzXBr0ly+pfJXaNjXy1+/cW7fmCMB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.569.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.569.0/index.min.mjs": "sha384-xknuGvOJkId3eOCMSafXM+2oTwTLbF8Ge04yzXBr0ly+pfJXaNjXy1+/cW7fmCMB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.569.0/LICENSE
```

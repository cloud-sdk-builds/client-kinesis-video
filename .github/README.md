...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.7.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.7.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dLfHbLdB314k1hc+gUd9BMEjO9gkq0WxyzXgmPgvi3HUx5WAIW45NQl+CI3dDwwK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.7.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.7.0/index.min.mjs": "sha384-dLfHbLdB314k1hc+gUd9BMEjO9gkq0WxyzXgmPgvi3HUx5WAIW45NQl+CI3dDwwK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.7.0/LICENSE
```

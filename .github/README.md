...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7H5y3ZFtfZJT7wUr1N3DfIls+yrhvB0AaBpBuTmbGdeSUeYqhav2JdYOX+pcvxvu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.993.0/index.min.mjs": "sha384-7H5y3ZFtfZJT7wUr1N3DfIls+yrhvB0AaBpBuTmbGdeSUeYqhav2JdYOX+pcvxvu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.993.0/LICENSE
```

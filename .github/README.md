...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.451.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.451.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/5/HqxTyYpbgGJ8zUWqduwd1benKkh4IzQP50H5Mzx3nr9gG0XHoYp+b7H2wwdJ/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.451.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.451.0/index.min.mjs": "sha384-/5/HqxTyYpbgGJ8zUWqduwd1benKkh4IzQP50H5Mzx3nr9gG0XHoYp+b7H2wwdJ/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.451.0/LICENSE
```

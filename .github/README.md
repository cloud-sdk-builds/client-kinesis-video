...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.1035.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.1035.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iy7iMt92/InxvBmoBTXNj8UqJ3+vsJKqygxvJVELMZl+hie/DTCldrt8l6TkFBd4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.1035.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.1035.0/index.min.mjs": "sha384-iy7iMt92/InxvBmoBTXNj8UqJ3+vsJKqygxvJVELMZl+hie/DTCldrt8l6TkFBd4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.1035.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.47.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.47.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-qxdsewsN7AKtGcuV6f1aU+8iRkNebQKhQNGCYhMGQ8Ctk+SfZNXXgdGN5FcjB+bQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.47.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.47.1/index.min.mjs": "sha384-qxdsewsN7AKtGcuV6f1aU+8iRkNebQKhQNGCYhMGQ8Ctk+SfZNXXgdGN5FcjB+bQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.47.1/LICENSE
```

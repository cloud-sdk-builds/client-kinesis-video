...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.4.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.4.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-wWmgCcdSFRkBz03zJQ79wAM2wSQRiK8o7WYherUTccr9fhm/SsRirc4YP6SJa+iO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.4.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.4.1/index.min.mjs": "sha384-wWmgCcdSFRkBz03zJQ79wAM2wSQRiK8o7WYherUTccr9fhm/SsRirc4YP6SJa+iO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.4.1/LICENSE
```

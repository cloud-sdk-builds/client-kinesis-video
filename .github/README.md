...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.162.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.162.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7JqEoqnqYxm2hyTyLEy2YU3vVQnvY+ejnmPcmCad/AYrw39r6XKRoJugdLs6cFg6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.162.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.162.0/index.min.mjs": "sha384-7JqEoqnqYxm2hyTyLEy2YU3vVQnvY+ejnmPcmCad/AYrw39r6XKRoJugdLs6cFg6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.162.0/LICENSE
```

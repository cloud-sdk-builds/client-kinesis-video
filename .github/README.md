...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.713.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IaqwKVOdWpH9deHImcNCP2Gb72TUCDgFbBWZYkMLv6rox0SO1zg4QNQbK+/R3w5f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.713.0/index.min.mjs": "sha384-IaqwKVOdWpH9deHImcNCP2Gb72TUCDgFbBWZYkMLv6rox0SO1zg4QNQbK+/R3w5f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.713.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.72.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.72.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LasYLKZRWeChLsV29DqKc8fj0Zcgjq+uErcjTFfQAj0WIN2Kdx6xobA+tP4cORq2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.72.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.72.0/index.min.mjs": "sha384-LasYLKZRWeChLsV29DqKc8fj0Zcgjq+uErcjTFfQAj0WIN2Kdx6xobA+tP4cORq2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.72.0/LICENSE
```

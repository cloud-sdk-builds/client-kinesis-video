...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.533.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.533.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ExaHfIuV/OQ7aLp1qmVdMsGO0yl8NqKSxcTnsXV3+fjqDLUgqiXMpUS1pYE08JC4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.533.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.533.0/index.min.mjs": "sha384-ExaHfIuV/OQ7aLp1qmVdMsGO0yl8NqKSxcTnsXV3+fjqDLUgqiXMpUS1pYE08JC4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.533.0/LICENSE
```

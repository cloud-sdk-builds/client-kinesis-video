...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.529.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.529.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-xTFwI4Es04qOfJXkiJ5zsT2CPoDGWwsJA5tLKLswYv8yq4fnAWQYRIfSJYdwbFNJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.529.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.529.1/index.min.mjs": "sha384-xTFwI4Es04qOfJXkiJ5zsT2CPoDGWwsJA5tLKLswYv8yq4fnAWQYRIfSJYdwbFNJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.529.1/LICENSE
```

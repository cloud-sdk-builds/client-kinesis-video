...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.218.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.218.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PV6OIGFykCPz6EAewlaiUTxcQWUC1W7NpgLhT/vvNbJIWVx2+noZBAGnT5Zk8Clo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.218.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.218.0/index.min.mjs": "sha384-PV6OIGFykCPz6EAewlaiUTxcQWUC1W7NpgLhT/vvNbJIWVx2+noZBAGnT5Zk8Clo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.218.0/LICENSE
```

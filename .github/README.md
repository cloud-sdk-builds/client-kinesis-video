...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.940.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.940.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-amQDv8bW0mpM9gd9IWOOmLKPZn1Co/EegttJ+z+FgEItvRyFFjud8kp6jt0kWJyp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.940.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.940.0/index.min.mjs": "sha384-amQDv8bW0mpM9gd9IWOOmLKPZn1Co/EegttJ+z+FgEItvRyFFjud8kp6jt0kWJyp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.940.0/LICENSE
```

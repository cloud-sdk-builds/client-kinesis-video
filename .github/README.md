...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.53.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.53.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AfsCp1++tFdqHKV3cULBzOFLtp9AanZfUH7Xh6Rn1PGsWn+uoCG5vkwocHUlGy3X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.53.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.53.0/index.min.mjs": "sha384-AfsCp1++tFdqHKV3cULBzOFLtp9AanZfUH7Xh6Rn1PGsWn+uoCG5vkwocHUlGy3X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.53.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.899.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.899.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Uwh1zCOsklYJxKMkkZcw+z199SMWCXaoeuNngoEykrKRn0FqKFzIaNvQ/2hY7O0a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.899.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.899.0/index.min.mjs": "sha384-Uwh1zCOsklYJxKMkkZcw+z199SMWCXaoeuNngoEykrKRn0FqKFzIaNvQ/2hY7O0a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.899.0/LICENSE
```

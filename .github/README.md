...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.87.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.87.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uErrL/vPTs3DcHO0SRpJaHBTyBg2fvjAp/K6gjR1R1yrNbhWwKYWAtfc6FpZ1B61
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.87.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.87.0/index.min.mjs": "sha384-uErrL/vPTs3DcHO0SRpJaHBTyBg2fvjAp/K6gjR1R1yrNbhWwKYWAtfc6FpZ1B61"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.87.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CBs4XLBbQGN+S7I0LzQVtGbluhrbvnMox4+nnU60FpclV6nPk0X17VQkpBTCsIij
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.966.0/index.min.mjs": "sha384-CBs4XLBbQGN+S7I0LzQVtGbluhrbvnMox4+nnU60FpclV6nPk0X17VQkpBTCsIij"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.966.0/LICENSE
```

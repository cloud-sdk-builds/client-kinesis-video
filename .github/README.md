...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.49.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.49.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V4ip8hVzItIX3yjJXP22+uPL2WQsQdxE5Rjw/rXBvQnMG9Alsm2IWaDCMzhwrUL1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.49.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.49.0/index.min.mjs": "sha384-V4ip8hVzItIX3yjJXP22+uPL2WQsQdxE5Rjw/rXBvQnMG9Alsm2IWaDCMzhwrUL1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.49.0/LICENSE
```

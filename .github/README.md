...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.987.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.987.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YViVMUjwVygLSqSyPUH59gTSpCb00ZZYvyMIO6tv42dwy+1V1XvpYQjDTl4BkPXt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.987.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.987.0/index.min.mjs": "sha384-YViVMUjwVygLSqSyPUH59gTSpCb00ZZYvyMIO6tv42dwy+1V1XvpYQjDTl4BkPXt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.987.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.826.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.826.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iYa1ziiJB1FKXaKr2GormdGTJ3x0XNBn0IajfjxSgEcGdKiwWSAopoJEcJ8qaGG+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.826.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.826.0/index.min.mjs": "sha384-iYa1ziiJB1FKXaKr2GormdGTJ3x0XNBn0IajfjxSgEcGdKiwWSAopoJEcJ8qaGG+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.826.0/LICENSE
```

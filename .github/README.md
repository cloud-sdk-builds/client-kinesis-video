...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.13.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.13.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-4s9RVwzD+d8+lQ71XdNogQKrYq5Y52I7pAKlcpiFzPr7xIsdI6REekiWyY0HJ/FJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.13.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.13.1/index.min.mjs": "sha384-4s9RVwzD+d8+lQ71XdNogQKrYq5Y52I7pAKlcpiFzPr7xIsdI6REekiWyY0HJ/FJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.13.1/LICENSE
```

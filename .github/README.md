...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.297.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.297.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rkEHNYeZUY/F5NQQpv6pVnYDXQBRXUKUyMuvSv8Z5w2y8CqrwYjI+5s4q3Jz6wWz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.297.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.297.0/index.min.mjs": "sha384-rkEHNYeZUY/F5NQQpv6pVnYDXQBRXUKUyMuvSv8Z5w2y8CqrwYjI+5s4q3Jz6wWz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.297.0/LICENSE
```

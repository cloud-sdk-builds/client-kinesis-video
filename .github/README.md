...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.465.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.465.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vV8QF2ASqvI9c6+QaO/3H6Vut+EUSnT+Y6JbllNs/vO+2PJsBLUbPz7mvRMRt2cI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.465.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.465.0/index.min.mjs": "sha384-vV8QF2ASqvI9c6+QaO/3H6Vut+EUSnT+Y6JbllNs/vO+2PJsBLUbPz7mvRMRt2cI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.465.0/LICENSE
```

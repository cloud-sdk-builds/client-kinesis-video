...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.54.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.54.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tlmWxeHy3H9udZEO4zOX4EDLE7rBg35wdloVTxxAvy7doTaiLaxR+spi/bM7zVqc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.54.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.54.0/index.min.mjs": "sha384-tlmWxeHy3H9udZEO4zOX4EDLE7rBg35wdloVTxxAvy7doTaiLaxR+spi/bM7zVqc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.54.0/LICENSE
```

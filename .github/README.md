...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZKENYJIAuj2movQobKoNGjohsDhNFiMuilQQWhomKZ/lQd3qxSoM2C5KA58VH8H0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.413.0/index.min.mjs": "sha384-ZKENYJIAuj2movQobKoNGjohsDhNFiMuilQQWhomKZ/lQd3qxSoM2C5KA58VH8H0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.413.0/LICENSE
```

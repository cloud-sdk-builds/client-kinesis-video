...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.577.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.577.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+COu/fePd5t4gmWB6QDYhiw2Rc/bvzm35DOCRSxVVgN39HdjPXkMsq4iXptyVCLi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.577.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.577.0/index.min.mjs": "sha384-+COu/fePd5t4gmWB6QDYhiw2Rc/bvzm35DOCRSxVVgN39HdjPXkMsq4iXptyVCLi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.577.0/LICENSE
```

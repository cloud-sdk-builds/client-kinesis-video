...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MaGV16kKgUdWIiO7JtWm3SNTfgO8j+/1GdAya3LQjoJk5QfFdNsWsTo7gDcr2FKw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.25.0/index.min.mjs": "sha384-MaGV16kKgUdWIiO7JtWm3SNTfgO8j+/1GdAya3LQjoJk5QfFdNsWsTo7gDcr2FKw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.25.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.188.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.188.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-puvnq/JT0jIppmulLaVQjOZL7yHCi0SoX45zFQuWKxPHlIKA7jrxgPiSRW7XVQrn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.188.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.188.0/index.min.mjs": "sha384-puvnq/JT0jIppmulLaVQjOZL7yHCi0SoX45zFQuWKxPHlIKA7jrxgPiSRW7XVQrn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.188.0/LICENSE
```

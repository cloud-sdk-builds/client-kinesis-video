...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.598.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.598.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VEXNuwBS6GjlgeoAtku1llwB6+HJhoxpTsJ/VN3uqAR5GKzHtbP7XisCO+x5CNOk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.598.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.598.0/index.min.mjs": "sha384-VEXNuwBS6GjlgeoAtku1llwB6+HJhoxpTsJ/VN3uqAR5GKzHtbP7XisCO+x5CNOk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.598.0/LICENSE
```

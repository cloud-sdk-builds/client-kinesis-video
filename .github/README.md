...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.410.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.410.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0MYlzRKTxUIdBZHImCLZjd1z8un2STirveWAAlWkSOszLKm9T1ebVzRUKy8xJ6Au
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.410.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.410.0/index.min.mjs": "sha384-0MYlzRKTxUIdBZHImCLZjd1z8un2STirveWAAlWkSOszLKm9T1ebVzRUKy8xJ6Au"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.410.0/LICENSE
```

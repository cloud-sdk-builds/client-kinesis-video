...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.10.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.10.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tTFRl/OayZyX3JyowFWQqvHvy5Tq5kl2Ki+/KOlquJdp2BRlzXpRJE9S5bzszhN0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.10.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.10.0/index.min.mjs": "sha384-tTFRl/OayZyX3JyowFWQqvHvy5Tq5kl2Ki+/KOlquJdp2BRlzXpRJE9S5bzszhN0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.10.0/LICENSE
```

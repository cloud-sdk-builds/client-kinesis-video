...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.8.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.8.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nGgB8Dwoxkqm5lvVadmr7SikIWCQYkZPRpAU4sf8pTPuaUJoRNgIME2d/CRg+6KR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.8.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.8.0/index.min.mjs": "sha384-nGgB8Dwoxkqm5lvVadmr7SikIWCQYkZPRpAU4sf8pTPuaUJoRNgIME2d/CRg+6KR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.8.0/LICENSE
```

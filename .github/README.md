...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.540.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.540.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O6Lyuzy1ecKDsGW3ASQqmKjMOwQCSXgkGCiMa8YBE8ApJOWKJiG7GeP+9P/ajA1U
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.540.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.540.0/index.min.mjs": "sha384-O6Lyuzy1ecKDsGW3ASQqmKjMOwQCSXgkGCiMa8YBE8ApJOWKJiG7GeP+9P/ajA1U"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.540.0/LICENSE
```

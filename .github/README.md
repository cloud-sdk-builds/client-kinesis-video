...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.596.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.596.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2bLmOZPFIK1m8WdJTGU4/5Vq5x1AH5vm1OPJu4ErhPu2SL5T5kkYSQI+0H9pDvmf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.596.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.596.0/index.min.mjs": "sha384-2bLmOZPFIK1m8WdJTGU4/5Vq5x1AH5vm1OPJu4ErhPu2SL5T5kkYSQI+0H9pDvmf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.596.0/LICENSE
```

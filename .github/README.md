...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.178.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.178.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x/QMtu8Zu2nYZJX2p11nB502wmhl8COx3DNkGODr/y0gdeEDi4FA2kBC8pn1ekm+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.178.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.178.0/index.min.mjs": "sha384-x/QMtu8Zu2nYZJX2p11nB502wmhl8COx3DNkGODr/y0gdeEDi4FA2kBC8pn1ekm+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.178.0/LICENSE
```

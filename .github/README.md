...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pvVYqC+8p81iXPooo+PTRue2DLOrTFp1jMPOV72boo4OCvi0mCu3VAYwuGQqt7xG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.799.0/index.min.mjs": "sha384-pvVYqC+8p81iXPooo+PTRue2DLOrTFp1jMPOV72boo4OCvi0mCu3VAYwuGQqt7xG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.799.0/LICENSE
```

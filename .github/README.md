...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.9.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.9.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CRQ5OHu3s+tpH+0iYx2lVmw4Y0f1B+Dt1JnsyLge0dDNxnTDWv7kpChpo9Pb5HSa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.9.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.9.0/index.min.mjs": "sha384-CRQ5OHu3s+tpH+0iYx2lVmw4Y0f1B+Dt1JnsyLge0dDNxnTDWv7kpChpo9Pb5HSa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.9.0/LICENSE
```

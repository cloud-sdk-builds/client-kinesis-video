...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MAYXuJnys+SDP3fmSUS7sHgmqwtiV9eHF9hfwRSttyTzlP8eAf0Y3uvcL8spF/S4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.327.0/index.min.mjs": "sha384-MAYXuJnys+SDP3fmSUS7sHgmqwtiV9eHF9hfwRSttyTzlP8eAf0Y3uvcL8spF/S4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.327.0/LICENSE
```

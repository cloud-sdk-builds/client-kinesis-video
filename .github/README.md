...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Sc10OfDEHpQPImpoqrRTqCnR2998nsP6eyzz4brdCKqaOU6aNIzU4K1NVV3zs+K5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.921.0/index.min.mjs": "sha384-Sc10OfDEHpQPImpoqrRTqCnR2998nsP6eyzz4brdCKqaOU6aNIzU4K1NVV3zs+K5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.921.0/LICENSE
```

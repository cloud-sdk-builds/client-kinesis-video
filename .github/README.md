...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.226.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.226.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wzM2+PZ+K8sIZgCljjy+nKZxWYtamVGxgQqQchoMGwcGpieOVylnUx+hGz70ig8W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.226.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.226.0/index.min.mjs": "sha384-wzM2+PZ+K8sIZgCljjy+nKZxWYtamVGxgQqQchoMGwcGpieOVylnUx+hGz70ig8W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.226.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-K6h+0v4vNFNABsX2iakUN6t5QbHZ9wtaOuPPqg7jdizQ3H5uopKod9rcRZy4QM4+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.118.1/index.min.mjs": "sha384-K6h+0v4vNFNABsX2iakUN6t5QbHZ9wtaOuPPqg7jdizQ3H5uopKod9rcRZy4QM4+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.118.1/LICENSE
```

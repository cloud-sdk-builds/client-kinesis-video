...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ciMJEaz1ZuqXF3qAwemNtOVaqbvx8kdrQSsuNydUraKFU6/Ysg3l55F3drm0wwFM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.906.0/index.min.mjs": "sha384-ciMJEaz1ZuqXF3qAwemNtOVaqbvx8kdrQSsuNydUraKFU6/Ysg3l55F3drm0wwFM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.906.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.458.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.458.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KMvnNzJlt5qj1xSHH/TssX5F1Fza7mGjebF8VOKfb9DewYAY7Vkh+fSk3+p8lKBG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.458.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.458.0/index.min.mjs": "sha384-KMvnNzJlt5qj1xSHH/TssX5F1Fza7mGjebF8VOKfb9DewYAY7Vkh+fSk3+p8lKBG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.458.0/LICENSE
```

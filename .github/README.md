...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-52MXAQXCje0g+aSJxQSuAK4Rym5GEdhtZXchuBxqjQ7+cgwqfZgegu54yK8P0zUT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.55.0/index.min.mjs": "sha384-52MXAQXCje0g+aSJxQSuAK4Rym5GEdhtZXchuBxqjQ7+cgwqfZgegu54yK8P0zUT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.55.0/LICENSE
```

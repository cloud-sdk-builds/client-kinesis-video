...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.934.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.934.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+Mu8BdEWjsOG8NC9KIrF+h2x1XHgLnfDj/uK4DpquL8tVEd7zbVP0J6iqLAE4msB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.934.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.934.0/index.min.mjs": "sha384-+Mu8BdEWjsOG8NC9KIrF+h2x1XHgLnfDj/uK4DpquL8tVEd7zbVP0J6iqLAE4msB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.934.0/LICENSE
```

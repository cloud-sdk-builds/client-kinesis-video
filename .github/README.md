...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.935.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.935.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eJ/4MWQHaXHRO2GiBz5uaWoUvYRvFaLxt9fIQTB+TocNgviV/VhG8TEKya3HqypN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.935.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.935.0/index.min.mjs": "sha384-eJ/4MWQHaXHRO2GiBz5uaWoUvYRvFaLxt9fIQTB+TocNgviV/VhG8TEKya3HqypN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.935.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.118.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l/BXeLtoWlXItgbVuIFBOhxjXh7/KUzxAQx9QNBiuS+fOidDbDQ0ht6NHGaUd7Kk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.118.0/index.min.mjs": "sha384-l/BXeLtoWlXItgbVuIFBOhxjXh7/KUzxAQx9QNBiuS+fOidDbDQ0ht6NHGaUd7Kk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.118.0/LICENSE
```

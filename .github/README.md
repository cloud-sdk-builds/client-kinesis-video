...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.30.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.30.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jsUW11afJw7QOn7YfbqHtNhcl7sKtK4LGkEK+5JHxpp4AxJ29OeGzBTGosVqvXB5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.30.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.30.0/index.min.mjs": "sha384-jsUW11afJw7QOn7YfbqHtNhcl7sKtK4LGkEK+5JHxpp4AxJ29OeGzBTGosVqvXB5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.30.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.864.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.864.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a1b5HbTk9sztl5+Fbo0PK+OQTxcBzZA9pr8ohAa8MxDs1tSQTL+/zUsTP+1c2TVf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.864.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.864.0/index.min.mjs": "sha384-a1b5HbTk9sztl5+Fbo0PK+OQTxcBzZA9pr8ohAa8MxDs1tSQTL+/zUsTP+1c2TVf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.864.0/LICENSE
```

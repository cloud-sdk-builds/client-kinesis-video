...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-COwHwQ0v3UBc01b4SZ+3qmVH10XDWDZEdmtRRuZ3AL6xkYdB+kvzm0Tl6K+ZBs/D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.919.0/index.min.mjs": "sha384-COwHwQ0v3UBc01b4SZ+3qmVH10XDWDZEdmtRRuZ3AL6xkYdB+kvzm0Tl6K+ZBs/D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.919.0/LICENSE
```

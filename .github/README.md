...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.236.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.236.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8WBQQuxuuIDwRTv2RF+QfWXccBJMG3vHaoBlnF9rFKdsJRJDlqGw6c2KK6h5Jf2e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.236.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.236.0/index.min.mjs": "sha384-8WBQQuxuuIDwRTv2RF+QfWXccBJMG3vHaoBlnF9rFKdsJRJDlqGw6c2KK6h5Jf2e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.236.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.658.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.658.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-FroVMKu9VjeHrpx/CeE0iVsAtOQ4UEimnO7HQq7kTNWNneO0thUVZaSAN7B62wP9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.658.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.658.1/index.min.mjs": "sha384-FroVMKu9VjeHrpx/CeE0iVsAtOQ4UEimnO7HQq7kTNWNneO0thUVZaSAN7B62wP9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.658.1/LICENSE
```

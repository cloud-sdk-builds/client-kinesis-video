...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.199.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.199.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oJYOFEaJiD2zMXj/E7gJbtS5fmXgWeNwHks/i1G8ellJozvPaUPNTyZICc9ZPDYr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.199.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.199.0/index.min.mjs": "sha384-oJYOFEaJiD2zMXj/E7gJbtS5fmXgWeNwHks/i1G8ellJozvPaUPNTyZICc9ZPDYr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.199.0/LICENSE
```

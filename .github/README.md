...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.730.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.730.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ys47QWAa5HxHrrZAbguoXGxMWlJALnoPbi3L9N2zefC8hdtCCJSxlDQkwEcJzj+V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.730.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.730.0/index.min.mjs": "sha384-Ys47QWAa5HxHrrZAbguoXGxMWlJALnoPbi3L9N2zefC8hdtCCJSxlDQkwEcJzj+V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.730.0/LICENSE
```

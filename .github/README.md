...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.894.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.894.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7QdeA59IxYLDfBXxnthLgbm0d4mjOS6BvUuj976egoxdieIoBmf/UBIQlmPz0Nbi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.894.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.894.0/index.min.mjs": "sha384-7QdeA59IxYLDfBXxnthLgbm0d4mjOS6BvUuj976egoxdieIoBmf/UBIQlmPz0Nbi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.894.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.17.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.17.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rmxjWgzLT64Ai0XlOz1BMp/8NmJjZWpqswSyaMwVvfQtTvqijkMlpdGsrmMmKqGU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.17.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.17.0/index.min.mjs": "sha384-rmxjWgzLT64Ai0XlOz1BMp/8NmJjZWpqswSyaMwVvfQtTvqijkMlpdGsrmMmKqGU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.17.0/LICENSE
```

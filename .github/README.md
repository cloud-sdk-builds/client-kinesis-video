...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.414.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.414.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Jy1IxPiQbZfXjNhdUjXfpX7y0VZNFkd4IW7aqvfbxpfVqb8qVRvL/QRzphlCu66M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.414.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.414.0/index.min.mjs": "sha384-Jy1IxPiQbZfXjNhdUjXfpX7y0VZNFkd4IW7aqvfbxpfVqb8qVRvL/QRzphlCu66M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.414.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+jNSWWhfmSK5lSZOWEJAOHjiRDOwr5meZ9QkoWxcyV83kF0zGG8jSbfe4pwg1Khl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.886.0/index.min.mjs": "sha384-+jNSWWhfmSK5lSZOWEJAOHjiRDOwr5meZ9QkoWxcyV83kF0zGG8jSbfe4pwg1Khl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.886.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.197.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.197.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CVXe/4P2mhRaV8t4WG8mAMLB9FYuQVo/gGCAOZ+vCVxGYPfRgqlSrx+I3cgrPNN9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.197.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.197.0/index.min.mjs": "sha384-CVXe/4P2mhRaV8t4WG8mAMLB9FYuQVo/gGCAOZ+vCVxGYPfRgqlSrx+I3cgrPNN9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.197.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.803.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.803.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QzRd3UPcykNPTVpzt5hf/9hl0t03JRTZNnIOv8cmwRhgsE+v2bqZoL/02nMizdMs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.803.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.803.0/index.min.mjs": "sha384-QzRd3UPcykNPTVpzt5hf/9hl0t03JRTZNnIOv8cmwRhgsE+v2bqZoL/02nMizdMs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.803.0/LICENSE
```

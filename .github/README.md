...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.362.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.362.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-liXgSVjhS+mfU+KmqtnuJfTF9PTRQdfKrd8LOQ8Gp1dWsQCPu7UZ+CR6oXMveMEs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.362.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.362.0/index.min.mjs": "sha384-liXgSVjhS+mfU+KmqtnuJfTF9PTRQdfKrd8LOQ8Gp1dWsQCPu7UZ+CR6oXMveMEs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.362.0/LICENSE
```

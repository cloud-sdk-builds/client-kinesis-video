...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.386.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.386.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mfcCJU9xXL/S2nhGvTc75XoNUIkOgPrMcRw01onKIwCfY4yHcahUCK2agZsSUdsY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.386.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.386.0/index.min.mjs": "sha384-mfcCJU9xXL/S2nhGvTc75XoNUIkOgPrMcRw01onKIwCfY4yHcahUCK2agZsSUdsY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.386.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.278.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.278.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ICiM+DHZfnl/pxcvXtnprDspQGEi0h824YIiAS+L/AEIJb1AwKEseuLQ53m5XrSH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.278.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.278.0/index.min.mjs": "sha384-ICiM+DHZfnl/pxcvXtnprDspQGEi0h824YIiAS+L/AEIJb1AwKEseuLQ53m5XrSH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.278.0/LICENSE
```

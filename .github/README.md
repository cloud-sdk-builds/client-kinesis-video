...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.46.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.46.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LuLL0cCUXT+yAPxcpeclFKZmK7TnJdEFWUKmU+CbB7sjjET1bJEeogep7Nc//38m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.46.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.46.0/index.min.mjs": "sha384-LuLL0cCUXT+yAPxcpeclFKZmK7TnJdEFWUKmU+CbB7sjjET1bJEeogep7Nc//38m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.46.0/LICENSE
```

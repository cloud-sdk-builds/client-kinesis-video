...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aRHJdKaBuvGDtKM+SPvo5WGqDUu4Hpn5gSQ8mR3uuBDdbL+ltEMmUpBlEmnXLe0V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.787.0/index.min.mjs": "sha384-aRHJdKaBuvGDtKM+SPvo5WGqDUu4Hpn5gSQ8mR3uuBDdbL+ltEMmUpBlEmnXLe0V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.787.0/LICENSE
```

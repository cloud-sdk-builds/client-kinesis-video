...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.52.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.52.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1ZkWECFS9QEVFKyLLFkWRVle/YZs7wIMnep65kVup4EB9lUZhoA4RfKgRB3D/+XD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.52.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.52.0/index.min.mjs": "sha384-1ZkWECFS9QEVFKyLLFkWRVle/YZs7wIMnep65kVup4EB9lUZhoA4RfKgRB3D/+XD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.52.0/LICENSE
```

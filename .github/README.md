...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.481.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.481.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mNd1sWRBZwa4EVAqIWuwEQs1lHpT/jjNTueUmmL/YP72tfC8vlflyvapM9BzxnI2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.481.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.481.0/index.min.mjs": "sha384-mNd1sWRBZwa4EVAqIWuwEQs1lHpT/jjNTueUmmL/YP72tfC8vlflyvapM9BzxnI2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.481.0/LICENSE
```

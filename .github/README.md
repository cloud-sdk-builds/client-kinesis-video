...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.170.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.170.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qzSKjMgOPfw1d+VTw5HWKrfP5mbLndpbf8Nx3P+H1c4dmxWS+Dz6Lm+m6mah8zsk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.170.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.170.0/index.min.mjs": "sha384-qzSKjMgOPfw1d+VTw5HWKrfP5mbLndpbf8Nx3P+H1c4dmxWS+Dz6Lm+m6mah8zsk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.170.0/LICENSE
```

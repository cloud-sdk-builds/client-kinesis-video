...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.341.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.341.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-npQR9+yMQgV+9Y6isF9hXX7QBvRLvU8+y9qrJEQFitH8s1hFw7Cj7zqkU9dfbiU/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.341.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.341.0/index.min.mjs": "sha384-npQR9+yMQgV+9Y6isF9hXX7QBvRLvU8+y9qrJEQFitH8s1hFw7Cj7zqkU9dfbiU/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.341.0/LICENSE
```

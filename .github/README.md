...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WVP1uackFILo9viHA8Z+aWlwUWt3sDZ7812KssQhoPsHJQFIZjDegxovdIAwSV8v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.999.0/index.min.mjs": "sha384-WVP1uackFILo9viHA8Z+aWlwUWt3sDZ7812KssQhoPsHJQFIZjDegxovdIAwSV8v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.999.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.293.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.293.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bNJqGqDD78cqlpRuVMJ0MmYNopIhudGXt5qBIk7/ICbqqtrFSMF0XdoIMw136S3X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.293.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.293.0/index.min.mjs": "sha384-bNJqGqDD78cqlpRuVMJ0MmYNopIhudGXt5qBIk7/ICbqqtrFSMF0XdoIMw136S3X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.293.0/LICENSE
```

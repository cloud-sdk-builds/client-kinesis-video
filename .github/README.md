...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.257.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.257.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IXxW03DFZyk1iTz+VB2sPcimah+C67flvZSsDWMZGpBMLEQpVK30Y40O8a+Ayfcm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.257.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.257.0/index.min.mjs": "sha384-IXxW03DFZyk1iTz+VB2sPcimah+C67flvZSsDWMZGpBMLEQpVK30Y40O8a+Ayfcm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.257.0/LICENSE
```

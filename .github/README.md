...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.958.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.958.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CQtWYYzS0nnQcfo+VQ4XgwpVZQ/oy9OuufQdRbdKWsssVjh+mZPJ71gjx7+ivX1E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.958.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.958.0/index.min.mjs": "sha384-CQtWYYzS0nnQcfo+VQ4XgwpVZQ/oy9OuufQdRbdKWsssVjh+mZPJ71gjx7+ivX1E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.958.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6ed4DBz3nrlS5Uiekrzqfonoawe7Zh0SOAw/L9TgmECHAhA1XZpigv6s6mE2xtTH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.855.0/index.min.mjs": "sha384-6ed4DBz3nrlS5Uiekrzqfonoawe7Zh0SOAw/L9TgmECHAhA1XZpigv6s6mE2xtTH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.855.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.716.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.716.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JwwTHrR4KRLWZU0vpuj2C1hCE5kjIlGO3VCa6DPhTwBzpyzwlr+tYV5KJX0xJfo4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.716.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.716.0/index.min.mjs": "sha384-JwwTHrR4KRLWZU0vpuj2C1hCE5kjIlGO3VCa6DPhTwBzpyzwlr+tYV5KJX0xJfo4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.716.0/LICENSE
```

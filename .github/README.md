...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.947.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.947.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V53/Pw2T2mQsDnxkaFA/Eks/nw2kTsNkFMevbpg5t8/9V6fkSObv3GMyvLQeS2n4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.947.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.947.0/index.min.mjs": "sha384-V53/Pw2T2mQsDnxkaFA/Eks/nw2kTsNkFMevbpg5t8/9V6fkSObv3GMyvLQeS2n4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.947.0/LICENSE
```

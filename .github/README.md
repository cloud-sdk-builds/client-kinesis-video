...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.309.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.309.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hd6/rJbmkOOu9NAdJH+ErmZIg0+rtR+EdKp9FnpMXqP5Dv0Xrx+c6szOziMrfRFh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.309.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.309.0/index.min.mjs": "sha384-hd6/rJbmkOOu9NAdJH+ErmZIg0+rtR+EdKp9FnpMXqP5Dv0Xrx+c6szOziMrfRFh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.309.0/LICENSE
```

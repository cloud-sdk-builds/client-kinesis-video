...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aZQUXwMahO5SeP2AecZNEWdmO/IMZzrCl5sTTxZxeJhhf5k0OwoHdabzaOwbypGU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.744.0/index.min.mjs": "sha384-aZQUXwMahO5SeP2AecZNEWdmO/IMZzrCl5sTTxZxeJhhf5k0OwoHdabzaOwbypGU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.744.0/LICENSE
```

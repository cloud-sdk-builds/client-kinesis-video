...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.6.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.6.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-AMG8tegy9IjIUoRYq8Pow+d60jrOj5CHnTjk3aOflqKs+TaO86O9lRESUrXWM6LE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.6.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.6.1/index.min.mjs": "sha384-AMG8tegy9IjIUoRYq8Pow+d60jrOj5CHnTjk3aOflqKs+TaO86O9lRESUrXWM6LE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.6.1/LICENSE
```

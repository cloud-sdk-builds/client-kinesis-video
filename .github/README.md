...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.193.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.193.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UWhPshYFAnWTpUzK1vS/X2IwZ/86S0kAz0ZNr1FDjEUVRhE2BmlQGI41kIBwjNUk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.193.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.193.0/index.min.mjs": "sha384-UWhPshYFAnWTpUzK1vS/X2IwZ/86S0kAz0ZNr1FDjEUVRhE2BmlQGI41kIBwjNUk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.193.0/LICENSE
```

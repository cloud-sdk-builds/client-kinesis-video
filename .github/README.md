...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.369.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.369.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-86ESw2o+AIHNnTx+/CagM69KmiiFkiCq/zKU9bnZYIQ2mqBu/ieHkYo9y9/+3Gwe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.369.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.369.0/index.min.mjs": "sha384-86ESw2o+AIHNnTx+/CagM69KmiiFkiCq/zKU9bnZYIQ2mqBu/ieHkYo9y9/+3Gwe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.369.0/LICENSE
```

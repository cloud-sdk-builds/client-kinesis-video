...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.347.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.347.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-cxPE1GJJTf16lTNndGpvjW7brqmEE2+ed7JyyzYp/Ia3egjoaO3K9Qd9NC8S6tE9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.347.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.347.1/index.min.mjs": "sha384-cxPE1GJJTf16lTNndGpvjW7brqmEE2+ed7JyyzYp/Ia3egjoaO3K9Qd9NC8S6tE9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.347.1/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.276.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.276.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FHdP+6qWSIISjVCyR0gyJGaHiIoekGaMn4wPV7dTAr0gp0U/Cpkn1qqvgxL0VHS1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.276.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.276.0/index.min.mjs": "sha384-FHdP+6qWSIISjVCyR0gyJGaHiIoekGaMn4wPV7dTAr0gp0U/Cpkn1qqvgxL0VHS1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.276.0/LICENSE
```

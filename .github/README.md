...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.554.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.554.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yokUqoLbJ+7VChPQlaKYt4XV8oHMzgQu7hmvjaEKjuAmZmS341Stxk47u8JCYRCl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.554.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.554.0/index.min.mjs": "sha384-yokUqoLbJ+7VChPQlaKYt4XV8oHMzgQu7hmvjaEKjuAmZmS341Stxk47u8JCYRCl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.554.0/LICENSE
```

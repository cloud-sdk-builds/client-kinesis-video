...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.282.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.282.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WJ6KLY3+ibp+eSSh/40uWPi8BJxRzgXc9Jwd3ik+fAq8nMrF/ob7BnDaj7uMhK9c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.282.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.282.0/index.min.mjs": "sha384-WJ6KLY3+ibp+eSSh/40uWPi8BJxRzgXc9Jwd3ik+fAq8nMrF/ob7BnDaj7uMhK9c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.282.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.105.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.105.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GkQ1yC8B0dG0JwvlZUmxJmgL3IJQo+phFafGoTwgAnjgecxcT3D3U7cQIXsxENgn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.105.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.105.0/index.min.mjs": "sha384-GkQ1yC8B0dG0JwvlZUmxJmgL3IJQo+phFafGoTwgAnjgecxcT3D3U7cQIXsxENgn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.105.0/LICENSE
```

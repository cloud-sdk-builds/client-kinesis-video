...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.835.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.835.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CKrrjoOkE2/6K76OBjCHj5oKn2mIMXaXAONs3mI8LKyI/7saZJXAtYOFgmNr/gXI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.835.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.835.0/index.min.mjs": "sha384-CKrrjoOkE2/6K76OBjCHj5oKn2mIMXaXAONs3mI8LKyI/7saZJXAtYOFgmNr/gXI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.835.0/LICENSE
```

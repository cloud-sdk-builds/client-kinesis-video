...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.523.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.523.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gmC+5WLT+WPq92TEI4CVIepXEDkePhiXmq8zerfZWecFOyHX/OScu7bCZX3Nfg3R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.523.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.523.0/index.min.mjs": "sha384-gmC+5WLT+WPq92TEI4CVIepXEDkePhiXmq8zerfZWecFOyHX/OScu7bCZX3Nfg3R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.523.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.204.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.204.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d6hxEXbtT5+bVnaX/IaFbsm3Yxi1+3DLK523fij/OhjaAh37qm14dqPmD9p3VDB1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.204.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.204.0/index.min.mjs": "sha384-d6hxEXbtT5+bVnaX/IaFbsm3Yxi1+3DLK523fij/OhjaAh37qm14dqPmD9p3VDB1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.204.0/LICENSE
```

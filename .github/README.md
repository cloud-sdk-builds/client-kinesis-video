...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.329.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.329.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8LX2r9+bvEKz3Y58/PINvchM86h9KYc1VwpZPa5jznvhju6QIwU4lq5Skj+J07k0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.329.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.329.0/index.min.mjs": "sha384-8LX2r9+bvEKz3Y58/PINvchM86h9KYc1VwpZPa5jznvhju6QIwU4lq5Skj+J07k0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.329.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.0.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.0.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-neH7hqAdGCMA51FoDTQD3o30w3IcN0djvPrvKYI6SoWucYJ6W2sULK6s3SPmh6w1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.0.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.0.0/index.min.mjs": "sha384-neH7hqAdGCMA51FoDTQD3o30w3IcN0djvPrvKYI6SoWucYJ6W2sULK6s3SPmh6w1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.0.0/LICENSE
```

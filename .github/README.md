...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.441.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.441.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qBFLKz1kywtT40suHAexUraXPAge1GcZC4eyxL2vJFfvxV8BjQgsbAuO7/81Ofn6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.441.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.441.0/index.min.mjs": "sha384-qBFLKz1kywtT40suHAexUraXPAge1GcZC4eyxL2vJFfvxV8BjQgsbAuO7/81Ofn6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.441.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.943.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.943.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dLuEsHT5P2K1GdAoz4/kUgJnBVjShnnj833XkusJpASRlGFqryfz3IxCuU5bHRne
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.943.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.943.0/index.min.mjs": "sha384-dLuEsHT5P2K1GdAoz4/kUgJnBVjShnnj833XkusJpASRlGFqryfz3IxCuU5bHRne"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.943.0/LICENSE
```

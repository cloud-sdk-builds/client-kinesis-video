...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.1036.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.1036.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ST9xNksp6ihnGJFWtCWqQyEivhoDNUP0B41jboRdxJR84w4EPs+fx4KCCLF/6NPr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.1036.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.1036.0/index.min.mjs": "sha384-ST9xNksp6ihnGJFWtCWqQyEivhoDNUP0B41jboRdxJR84w4EPs+fx4KCCLF/6NPr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.1036.0/LICENSE
```

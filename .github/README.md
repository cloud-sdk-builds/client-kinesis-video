...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.893.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.893.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZO1KmlhdXzaY3LDxbHPlTG9qxnFv1KbAeBPHZlx9lPTZwUuwLhX74pD8qft2aWeM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.893.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.893.0/index.min.mjs": "sha384-ZO1KmlhdXzaY3LDxbHPlTG9qxnFv1KbAeBPHZlx9lPTZwUuwLhX74pD8qft2aWeM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.893.0/LICENSE
```

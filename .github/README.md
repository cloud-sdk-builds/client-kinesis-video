...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.54.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.54.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Um5HulWXWXFowz6CjyNKgiDnPzS9ulngEeZJBc+vZIoY/lF9gGOiVzC9zp+jr7ng
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.54.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.54.1/index.min.mjs": "sha384-Um5HulWXWXFowz6CjyNKgiDnPzS9ulngEeZJBc+vZIoY/lF9gGOiVzC9zp+jr7ng"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.54.1/LICENSE
```

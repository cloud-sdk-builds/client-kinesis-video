...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.18.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.18.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sb4pYHRN6gZ16w2AXYsllZeibN4XI60Ga+2qyuO9MBeTH8wwh3HxEI+HgxmkQxFu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.18.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.18.0/index.min.mjs": "sha384-sb4pYHRN6gZ16w2AXYsllZeibN4XI60Ga+2qyuO9MBeTH8wwh3HxEI+HgxmkQxFu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.18.0/LICENSE
```

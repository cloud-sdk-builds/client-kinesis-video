...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BrMygn51GEeg7EqqcZY7lAhMI+n4kb+mkCuXEIwZil59T36HN64bZsBh1/LPso5X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.777.0/index.min.mjs": "sha384-BrMygn51GEeg7EqqcZY7lAhMI+n4kb+mkCuXEIwZil59T36HN64bZsBh1/LPso5X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.777.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.328.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.328.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1vHNMhKUa6eqKXMsKLdaKjOuSvc623t1vvZ4pm37SltOaFmwG8r+H+pPmy/CtMJq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.328.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.328.0/index.min.mjs": "sha384-1vHNMhKUa6eqKXMsKLdaKjOuSvc623t1vvZ4pm37SltOaFmwG8r+H+pPmy/CtMJq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.328.0/LICENSE
```

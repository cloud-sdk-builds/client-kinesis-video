...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.23.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.23.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m5urotV69qUcUKy7hcSKIbcKisNXJxgLSOLpXqPYs/LLoKn5vqWaY6BdvNNww4es
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.23.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.23.0/index.min.mjs": "sha384-m5urotV69qUcUKy7hcSKIbcKisNXJxgLSOLpXqPYs/LLoKn5vqWaY6BdvNNww4es"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.23.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.234.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.234.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4h6jTVmvg6sjtzJhC57+gi+KMVcp27K9HxEXmsFeWgWh9uDgQ6hLUujvt1rRS6bP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.234.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.234.0/index.min.mjs": "sha384-4h6jTVmvg6sjtzJhC57+gi+KMVcp27K9HxEXmsFeWgWh9uDgQ6hLUujvt1rRS6bP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.234.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.222.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.222.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ah1E6TZXPIsZ/9aLTYrPQ+1HaPedv9DEpdD6pztxqHzU4vnGblBelIao6elzNnzH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.222.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.222.0/index.min.mjs": "sha384-ah1E6TZXPIsZ/9aLTYrPQ+1HaPedv9DEpdD6pztxqHzU4vnGblBelIao6elzNnzH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.222.0/LICENSE
```

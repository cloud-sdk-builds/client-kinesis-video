...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.714.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.714.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IZIH2hzig0A47aWdxCgURurtCGixisJ3IwUS9vEQ3pHQEx89sl6kg+uQLinFA6eh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.714.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.714.0/index.min.mjs": "sha384-IZIH2hzig0A47aWdxCgURurtCGixisJ3IwUS9vEQ3pHQEx89sl6kg+uQLinFA6eh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.714.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.952.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.952.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i8VTv81TUKu6M861azWSslLjnEcGyd/damxhhyrUVAePw0V80bkN7lYvGawJzUin
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.952.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.952.0/index.min.mjs": "sha384-i8VTv81TUKu6M861azWSslLjnEcGyd/damxhhyrUVAePw0V80bkN7lYvGawJzUin"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.952.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S8Cv+DUTv2DCiGiYvyxCaSxRg0qlkjKHIBDcPuqoLNGXU+oUdzTdMgl4E9x+YF+l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.192.0/index.min.mjs": "sha384-S8Cv+DUTv2DCiGiYvyxCaSxRg0qlkjKHIBDcPuqoLNGXU+oUdzTdMgl4E9x+YF+l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.192.0/LICENSE
```

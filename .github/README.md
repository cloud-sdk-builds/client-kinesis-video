...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.679.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kCObWIqxJCLaP+FIb3l4Q+U+5s8ELUCh5DnjgbT/dz1J6BACH7rtGXy3XoCORsbC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.679.0/index.min.mjs": "sha384-kCObWIqxJCLaP+FIb3l4Q+U+5s8ELUCh5DnjgbT/dz1J6BACH7rtGXy3XoCORsbC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.679.0/LICENSE
```

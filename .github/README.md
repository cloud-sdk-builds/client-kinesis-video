...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.485.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.485.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e2sMB7uvL9nAXS9YavtnujCvdCoCg62tmI/vflIfC+5u0up/jGIJXCeolNTXgEIX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.485.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.485.0/index.min.mjs": "sha384-e2sMB7uvL9nAXS9YavtnujCvdCoCg62tmI/vflIfC+5u0up/jGIJXCeolNTXgEIX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.485.0/LICENSE
```

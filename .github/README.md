...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FLBED+6xGfh5pxPJZq3f0wjlrcjmieHi9qfPfUx0LH9RSrgut/EYGMAoDcInibP1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.435.0/index.min.mjs": "sha384-FLBED+6xGfh5pxPJZq3f0wjlrcjmieHi9qfPfUx0LH9RSrgut/EYGMAoDcInibP1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.435.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.461.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.461.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZceS+TgISQn9qnHvZR0BOieRqfu32L6KTIMh67PPlOPBlxssQv1igTO+f/1VoF6r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.461.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.461.0/index.min.mjs": "sha384-ZceS+TgISQn9qnHvZR0BOieRqfu32L6KTIMh67PPlOPBlxssQv1igTO+f/1VoF6r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.461.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.582.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.582.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9F9HnbsdMN23R3hGKtE1zQsURdiaJfvsUiT7Yj3ZEdNz0/PQA/+/34BkGgQMU1eH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.582.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.582.0/index.min.mjs": "sha384-9F9HnbsdMN23R3hGKtE1zQsURdiaJfvsUiT7Yj3ZEdNz0/PQA/+/34BkGgQMU1eH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.582.0/LICENSE
```

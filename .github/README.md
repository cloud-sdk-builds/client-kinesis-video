...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.499.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.499.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tgDxyE9Fj04P+/2zjLm3L370se8yUtBkFxrMSgrHrbnFRHhscmqjoH8N66dxkZ85
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.499.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.499.0/index.min.mjs": "sha384-tgDxyE9Fj04P+/2zjLm3L370se8yUtBkFxrMSgrHrbnFRHhscmqjoH8N66dxkZ85"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.499.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.142.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.142.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cL2yLI6LfOec5/ULaTdh+TvyznHybep5AkSpuPDHI52WYQgD+P3cfw8eb/rjiAnC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.142.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.142.0/index.min.mjs": "sha384-cL2yLI6LfOec5/ULaTdh+TvyznHybep5AkSpuPDHI52WYQgD+P3cfw8eb/rjiAnC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.142.0/LICENSE
```

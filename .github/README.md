...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QNiZI3fxi2AYG3RAXYx/6HRi/8XDSaBYpqiJF1ObUlEjsZHkqnR7/x+QecWevUcn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.775.0/index.min.mjs": "sha384-QNiZI3fxi2AYG3RAXYx/6HRi/8XDSaBYpqiJF1ObUlEjsZHkqnR7/x+QecWevUcn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.775.0/LICENSE
```

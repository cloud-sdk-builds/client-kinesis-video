...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.556.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.556.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u3vnGDthcwNA/rb6AZsQ/yEmKhtWNEQ22sCDxPR/zK1PAxCCVUbURU00WQS3bYcU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.556.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.556.0/index.min.mjs": "sha384-u3vnGDthcwNA/rb6AZsQ/yEmKhtWNEQ22sCDxPR/zK1PAxCCVUbURU00WQS3bYcU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.556.0/LICENSE
```

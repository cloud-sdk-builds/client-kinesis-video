...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.281.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.281.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zXBZPbFSzK2MGVdtCxMVE5SGR7sTmqNKoN9uJBsWbehv7Lh4RjiaC+3Lk/z/sSKm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.281.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.281.0/index.min.mjs": "sha384-zXBZPbFSzK2MGVdtCxMVE5SGR7sTmqNKoN9uJBsWbehv7Lh4RjiaC+3Lk/z/sSKm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.281.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Boo+F3KsyzQVU+SC0vO7rBLNN0+sdwhS4rGnPCtpozgNtsXMfe+UfkpUvOsfVlX3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.916.0/index.min.mjs": "sha384-Boo+F3KsyzQVU+SC0vO7rBLNN0+sdwhS4rGnPCtpozgNtsXMfe+UfkpUvOsfVlX3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.916.0/LICENSE
```

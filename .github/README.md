...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.883.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.883.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hIrxd/BzBLoyASDDS5rYewAJtaa16nf6RQXpqmHIuSg24HMHrvS2mmYb/5Ntmei8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.883.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.883.0/index.min.mjs": "sha384-hIrxd/BzBLoyASDDS5rYewAJtaa16nf6RQXpqmHIuSg24HMHrvS2mmYb/5Ntmei8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.883.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.423.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CxKrD3t6I0NffGELMA0/3cVD8CZqWDc0fC1NjqGRpAEiNc/UFyASUxJWnOrgbNmw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.423.0/index.min.mjs": "sha384-CxKrD3t6I0NffGELMA0/3cVD8CZqWDc0fC1NjqGRpAEiNc/UFyASUxJWnOrgbNmw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.423.0/LICENSE
```

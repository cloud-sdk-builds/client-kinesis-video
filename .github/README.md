...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.361.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.361.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9MOJs7tdmg8Z3ZWv/geYyMtr1pqZ5VKI0EPvPPWV3qzZibW2FPtrA6yz+xdtUHJ5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.361.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.361.0/index.min.mjs": "sha384-9MOJs7tdmg8Z3ZWv/geYyMtr1pqZ5VKI0EPvPPWV3qzZibW2FPtrA6yz+xdtUHJ5"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.361.0`)
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.361.0/LICENSE
```

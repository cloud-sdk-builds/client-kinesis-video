...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mej51G4N9f69VVfbhcqbT22p1CgMaKs+xBSDpVilv/5B+YvNOx1ojj916Mqwo6di
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.310.0/index.min.mjs": "sha384-mej51G4N9f69VVfbhcqbT22p1CgMaKs+xBSDpVilv/5B+YvNOx1ojj916Mqwo6di"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.310.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.990.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.990.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l01IEP5iNpO1WGTazo+uwuhJaml47EhZ+pxoPReLzl+y2Jq0XRjd8SSwyIMBXRO+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.990.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.990.0/index.min.mjs": "sha384-l01IEP5iNpO1WGTazo+uwuhJaml47EhZ+pxoPReLzl+y2Jq0XRjd8SSwyIMBXRO+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.990.0/LICENSE
```

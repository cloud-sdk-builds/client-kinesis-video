...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.632.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.632.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-obUU0EfQrSQZuI3FFFpVek5UBXSUfx2wnktj5mFObQ5oBuwsxnE2hO/mRDtwVFfa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.632.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.632.0/index.min.mjs": "sha384-obUU0EfQrSQZuI3FFFpVek5UBXSUfx2wnktj5mFObQ5oBuwsxnE2hO/mRDtwVFfa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.632.0/LICENSE
```

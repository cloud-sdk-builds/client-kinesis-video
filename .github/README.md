...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3b1IRkfgXj+i61ovjtRdHebUAzwZBJv9N2cRm5e/JGWp+hFp/lVe6nsj7rNQjUCQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.873.0/index.min.mjs": "sha384-3b1IRkfgXj+i61ovjtRdHebUAzwZBJv9N2cRm5e/JGWp+hFp/lVe6nsj7rNQjUCQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.873.0/LICENSE
```

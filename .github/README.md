...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.100.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wmD7TcXxPxArhbouVbKYxAQwwuSEZtZhYJ77BWnXgp++0o/K+ZC4UiVS09K8GwSe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.100.0/index.min.mjs": "sha384-wmD7TcXxPxArhbouVbKYxAQwwuSEZtZhYJ77BWnXgp++0o/K+ZC4UiVS09K8GwSe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.100.0/LICENSE
```

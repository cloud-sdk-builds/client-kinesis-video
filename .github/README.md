...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x6+/p/xXsdRilEcP2s2BgLF2UZJEIlrzK7NIcJVl6MBmoT9tzQts1ecAKU5DFg1w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.552.0/index.min.mjs": "sha384-x6+/p/xXsdRilEcP2s2BgLF2UZJEIlrzK7NIcJVl6MBmoT9tzQts1ecAKU5DFg1w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.552.0/LICENSE
```

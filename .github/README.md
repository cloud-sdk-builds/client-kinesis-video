...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.50.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.50.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A23rAOX2DLuRbFhzq0GxNUTwHfdCMVGsd8VquW7m1OqfbKUHbUrMWu5xxyNRh9Ed
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.50.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.50.0/index.min.mjs": "sha384-A23rAOX2DLuRbFhzq0GxNUTwHfdCMVGsd8VquW7m1OqfbKUHbUrMWu5xxyNRh9Ed"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.50.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.929.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.929.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C/D2m1HTSKbBollRo5A2GgmpZiz/ePRAvbRMexXiEHCVQlqU6a2CghCrcHH1Feu6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.929.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.929.0/index.min.mjs": "sha384-C/D2m1HTSKbBollRo5A2GgmpZiz/ePRAvbRMexXiEHCVQlqU6a2CghCrcHH1Feu6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.929.0/LICENSE
```

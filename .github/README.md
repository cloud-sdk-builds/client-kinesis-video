...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.200.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.200.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rzEFVHsstDr8ymC+a5LuVXbBwqYBGfb/8eZI+ApD//4REQAd5OJB9Om4zHRSNEFu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.200.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.200.0/index.min.mjs": "sha384-rzEFVHsstDr8ymC+a5LuVXbBwqYBGfb/8eZI+ApD//4REQAd5OJB9Om4zHRSNEFu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.200.0/LICENSE
```

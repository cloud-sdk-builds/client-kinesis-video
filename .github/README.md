...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LQwJUM5KORusjT7pNHcYuhO0aWNqhqj/nD+8UFFoiWuxzxb7/2v2nB3Df88lBYsA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.47.0/index.min.mjs": "sha384-LQwJUM5KORusjT7pNHcYuhO0aWNqhqj/nD+8UFFoiWuxzxb7/2v2nB3Df88lBYsA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.47.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.32.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.32.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VaZPE+MX2+ir/pGnSl33v31KF4+0VWWTt3EAMSUcWL9Ys+Qg3ssnhql0GmQ1fLC8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.32.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.32.0/index.min.mjs": "sha384-VaZPE+MX2+ir/pGnSl33v31KF4+0VWWTt3EAMSUcWL9Ys+Qg3ssnhql0GmQ1fLC8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.32.0/LICENSE
```

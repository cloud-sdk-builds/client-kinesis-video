...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uX/JW/oMH8Xvkika3hAjVBJgHRuYooHsoUAhu3OrWDvklO5R/0dXEkmXj0dnccor
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.254.0/index.min.mjs": "sha384-uX/JW/oMH8Xvkika3hAjVBJgHRuYooHsoUAhu3OrWDvklO5R/0dXEkmXj0dnccor"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.254.0/LICENSE
```

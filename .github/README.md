...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.231.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.231.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ljW51H4NKJ10Ogny2eYg8ywPOpJtTG5dfRj/dyIX+sSCwmjprWsqfnMhJJd3SvGW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.231.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.231.0/index.min.mjs": "sha384-ljW51H4NKJ10Ogny2eYg8ywPOpJtTG5dfRj/dyIX+sSCwmjprWsqfnMhJJd3SvGW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.231.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BnTpiuOMdDwH354khkwj3OYcZii/cAE2SnKYU+0muNrXWSP9Xy77tXtgd+Ey2XSN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.709.0/index.min.mjs": "sha384-BnTpiuOMdDwH354khkwj3OYcZii/cAE2SnKYU+0muNrXWSP9Xy77tXtgd+Ey2XSN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.709.0/LICENSE
```

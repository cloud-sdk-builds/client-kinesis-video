...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.421.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.421.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2fi49VQO3LcYpyfdCMHRlf1A9FO8gWwUHf4R9dHgbEe6eheLOLetgdgySb1hxiTl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.421.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.421.0/index.min.mjs": "sha384-2fi49VQO3LcYpyfdCMHRlf1A9FO8gWwUHf4R9dHgbEe6eheLOLetgdgySb1hxiTl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.421.0/LICENSE
```

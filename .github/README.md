...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.609.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.609.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zsx7PR2yzwrL1FuU1xEAbfxW+VSIFiPZ5EYeUmb24HqKZT+fQoxOxiFnFR8hZS42
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.609.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.609.0/index.min.mjs": "sha384-zsx7PR2yzwrL1FuU1xEAbfxW+VSIFiPZ5EYeUmb24HqKZT+fQoxOxiFnFR8hZS42"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.609.0/LICENSE
```

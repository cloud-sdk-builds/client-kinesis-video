...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.335.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.335.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hlj3hUm92hKXGqLcrGoIdoSL90ZmqnKU98zfsojpy1gVcKudD0+r2+3YSl8GEPsm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.335.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.335.0/index.min.mjs": "sha384-Hlj3hUm92hKXGqLcrGoIdoSL90ZmqnKU98zfsojpy1gVcKudD0+r2+3YSl8GEPsm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.335.0/LICENSE
```

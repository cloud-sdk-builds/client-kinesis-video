...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T0a+EX8vxHUKKD+tL8zeiGwk4/RQA9AwwcPtyXci2bTIKE4b4dYBRGlCWFu1RCK/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.677.0/index.min.mjs": "sha384-T0a+EX8vxHUKKD+tL8zeiGwk4/RQA9AwwcPtyXci2bTIKE4b4dYBRGlCWFu1RCK/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.677.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.495.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.495.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d9a+i7EmAVeZPn1YcId1IOykASFBdXW7kwHSgAJJR6fGvuWu0hFI2QCm63hXVDXE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.495.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.495.0/index.min.mjs": "sha384-d9a+i7EmAVeZPn1YcId1IOykASFBdXW7kwHSgAJJR6fGvuWu0hFI2QCm63hXVDXE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.495.0/LICENSE
```

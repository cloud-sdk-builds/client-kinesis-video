...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.22.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.22.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PEVnBW0yO7olkAlA1p6Dmf3NprUWCWA9JjDJOOkHol4ZMt+yG2x6AVM1MyB6H2Qc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.22.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.22.0/index.min.mjs": "sha384-PEVnBW0yO7olkAlA1p6Dmf3NprUWCWA9JjDJOOkHol4ZMt+yG2x6AVM1MyB6H2Qc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.22.0/LICENSE
```

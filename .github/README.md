...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gze0MXSroWS43k6JH4V3l7Dnrlz9ff1/raI9Ms4aUqnDBR0zOwvFxcVceD2RMKow
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.616.0/index.min.mjs": "sha384-Gze0MXSroWS43k6JH4V3l7Dnrlz9ff1/raI9Ms4aUqnDBR0zOwvFxcVceD2RMKow"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.616.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.918.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.918.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pZC8A+3DboeSuQuKOQ1ro8xATzzYrbPIrWYLdfHBQqQihYw/C+9wF6hl1TJhsaXO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.918.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.918.0/index.min.mjs": "sha384-pZC8A+3DboeSuQuKOQ1ro8xATzzYrbPIrWYLdfHBQqQihYw/C+9wF6hl1TJhsaXO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.918.0/LICENSE
```

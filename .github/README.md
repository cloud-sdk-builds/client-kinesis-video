...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.29.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.29.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aufMPpuPdU40XAtUrHS1oFBEuE5NIIdUVFq9wrpykYVSnHwxZ92AqtXZ3HbkqGVJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.29.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.29.0/index.min.mjs": "sha384-aufMPpuPdU40XAtUrHS1oFBEuE5NIIdUVFq9wrpykYVSnHwxZ92AqtXZ3HbkqGVJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.29.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.1021.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.1021.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7s0uZxivaxOKRFAqDaUEZrP/hclNqo/lGdTwAOV9h4u4xAUnC06TbcxC3oh/0ecp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.1021.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.1021.0/index.min.mjs": "sha384-7s0uZxivaxOKRFAqDaUEZrP/hclNqo/lGdTwAOV9h4u4xAUnC06TbcxC3oh/0ecp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.1021.0/LICENSE
```

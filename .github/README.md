...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.312.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.312.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r/1wKwsFHAcbsLC6okkUb29pKeLsU9Stkwuo3/9cCDesU7/KVmwY9zThJs6LQDa4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.312.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.312.0/index.min.mjs": "sha384-r/1wKwsFHAcbsLC6okkUb29pKeLsU9Stkwuo3/9cCDesU7/KVmwY9zThJs6LQDa4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.312.0/LICENSE
```

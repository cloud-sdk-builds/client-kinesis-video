...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.484.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.484.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GA9aoDIVF7UDGWT4B2TfgX5ToW2JPvotAwDdb+FPfx5YBSRXoPsrbFoZrfZRE0Ku
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.484.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.484.0/index.min.mjs": "sha384-GA9aoDIVF7UDGWT4B2TfgX5ToW2JPvotAwDdb+FPfx5YBSRXoPsrbFoZrfZRE0Ku"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.484.0/LICENSE
```

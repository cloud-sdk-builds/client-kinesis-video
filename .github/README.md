...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.8.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.8.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-dnknHipt08k6jnGw0/o1R5SKke8oeIaN+jNwfG62l0vJxucxa7/CafWnKH0/JxRI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.8.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.8.1/index.min.mjs": "sha384-dnknHipt08k6jnGw0/o1R5SKke8oeIaN+jNwfG62l0vJxucxa7/CafWnKH0/JxRI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.8.1/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.300.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.300.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fNqfJmJrv5Wq4OVSaD/kpGv4K4aizkMjvLmuDvSZpfPquO4fp5DPEIDfyh4f6oZU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.300.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.300.0/index.min.mjs": "sha384-fNqfJmJrv5Wq4OVSaD/kpGv4K4aizkMjvLmuDvSZpfPquO4fp5DPEIDfyh4f6oZU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.300.0/LICENSE
```

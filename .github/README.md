...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lVGjepraWaUpZTMjk6f4Bn/u+4w5nW95OvbtGSNBsb3Sdl2zrpe+1KJIVZbkildF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.658.0/index.min.mjs": "sha384-lVGjepraWaUpZTMjk6f4Bn/u+4w5nW95OvbtGSNBsb3Sdl2zrpe+1KJIVZbkildF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.658.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.298.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.298.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cB+wmSupGxL6YGnY3N0xevLJv+e+JJmiwPThHeo9jggLDSL5GodvLdkLMlOdJ1Va
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.298.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.298.0/index.min.mjs": "sha384-cB+wmSupGxL6YGnY3N0xevLJv+e+JJmiwPThHeo9jggLDSL5GodvLdkLMlOdJ1Va"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.298.0/LICENSE
```

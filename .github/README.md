...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.731.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.731.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CwEz2zpT2pKlh+wkoMURheaVVl2EDHX2wC3c7LUTchHSPethCxcpNtceg1+jRURo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.731.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.731.0/index.min.mjs": "sha384-CwEz2zpT2pKlh+wkoMURheaVVl2EDHX2wC3c7LUTchHSPethCxcpNtceg1+jRURo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.731.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NEjm3gxvDvCGcdttCXJgFZcQXLjEOcR5YltynYMYxM41Pc+DO6BiSUAmwQH6tMcN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.289.0/index.min.mjs": "sha384-NEjm3gxvDvCGcdttCXJgFZcQXLjEOcR5YltynYMYxM41Pc+DO6BiSUAmwQH6tMcN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.289.0/LICENSE
```

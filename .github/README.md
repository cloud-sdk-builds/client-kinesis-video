...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.2.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.2.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oWMXkBxECpgqOV25aMyqkERJcLD4baMSRZSKoy8O19/LxdDRNWhA1cuVXCFOPa7Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.2.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.2.0/index.min.mjs": "sha384-oWMXkBxECpgqOV25aMyqkERJcLD4baMSRZSKoy8O19/LxdDRNWhA1cuVXCFOPa7Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.2.0/LICENSE
```

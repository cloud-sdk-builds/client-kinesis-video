...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+2FH3Oh37XjmDG7/O+lqH7hfTD7/3APITnLvN3cu5OC/PdSAU6wNroj/hrD/fIO4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.876.0/index.min.mjs": "sha384-+2FH3Oh37XjmDG7/O+lqH7hfTD7/3APITnLvN3cu5OC/PdSAU6wNroj/hrD/fIO4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.876.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.185.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.185.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BJvq7tLGw2s/GIUr62ENSkYlYsoQHZA4Ws3G7ipIoTa38cKqYO5AqeXEyzkAGKHO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.185.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.185.0/index.min.mjs": "sha384-BJvq7tLGw2s/GIUr62ENSkYlYsoQHZA4Ws3G7ipIoTa38cKqYO5AqeXEyzkAGKHO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.185.0/LICENSE
```

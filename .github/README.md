...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h2m0GJ9UlBUgGc5Ke3ZeGbnJIFrMIhrgaX9oyzP3mDQJC7GZnbPI3MzhprlWYTXo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.848.0/index.min.mjs": "sha384-h2m0GJ9UlBUgGc5Ke3ZeGbnJIFrMIhrgaX9oyzP3mDQJC7GZnbPI3MzhprlWYTXo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.848.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.95.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.95.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EH5DltfQmPJpSLywdb7WTIdqbuYQiD83TTCYbnrhAHGLGkVhvUc20BrzXPA1nNmP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.95.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.95.0/index.min.mjs": "sha384-EH5DltfQmPJpSLywdb7WTIdqbuYQiD83TTCYbnrhAHGLGkVhvUc20BrzXPA1nNmP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.95.0/LICENSE
```

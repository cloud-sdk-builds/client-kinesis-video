...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.564.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.564.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C3iiSS9xsNNjMR9zYHV62STE15VKqqXPE9MjX2aPGhliupuK/QSenNTYeTTHUWKT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.564.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.564.0/index.min.mjs": "sha384-C3iiSS9xsNNjMR9zYHV62STE15VKqqXPE9MjX2aPGhliupuK/QSenNTYeTTHUWKT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.564.0/LICENSE
```

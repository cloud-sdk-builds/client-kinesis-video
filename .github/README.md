...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Cy7wKx7pGEURVF+nkZWGosl7S8oVWPwd/gXZCfguJa4Ew2gOpkXZNAqIqJrn5doI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.503.1/index.min.mjs": "sha384-Cy7wKx7pGEURVF+nkZWGosl7S8oVWPwd/gXZCfguJa4Ew2gOpkXZNAqIqJrn5doI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.503.1/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bZH/tacEg/TI3zOK1y9l0wmW3bTMTAOHweZ7rrQKBmqNTRF258chNypph0dNFFBZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.692.0/index.min.mjs": "sha384-bZH/tacEg/TI3zOK1y9l0wmW3bTMTAOHweZ7rrQKBmqNTRF258chNypph0dNFFBZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.692.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.478.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.478.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GeL/DV1P4wAUhyxwMqcWL2U0eBZUzKzX1HUO76j3IeHZjN6bJpUBsyWMBoXgwxSy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.478.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.478.0/index.min.mjs": "sha384-GeL/DV1P4wAUhyxwMqcWL2U0eBZUzKzX1HUO76j3IeHZjN6bJpUBsyWMBoXgwxSy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.478.0/LICENSE
```

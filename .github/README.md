...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hBjiQAr9QHqtYEnlHWDfx6MnFuL8ZBnDjpu5xWR1aH+fjxSi/6WTkD/Yl8wSvgUp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.726.0/index.min.mjs": "sha384-hBjiQAr9QHqtYEnlHWDfx6MnFuL8ZBnDjpu5xWR1aH+fjxSi/6WTkD/Yl8wSvgUp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.726.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.363.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.363.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-To/NRP/1Oj21e89vfcpvR/LIVykoJjfSIc+JZVEN+GLE9mjrN/KnLvikufieorJO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.363.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.363.0/index.min.mjs": "sha384-To/NRP/1Oj21e89vfcpvR/LIVykoJjfSIc+JZVEN+GLE9mjrN/KnLvikufieorJO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.363.0/LICENSE
```

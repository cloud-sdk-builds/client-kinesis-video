...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.438.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.438.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8b+YfnUy2SSUYxWNbgXoICpDNcjgwQn1Tq9lPEwmPOzSEb25gBL/DQrfgwV146mq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.438.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.438.0/index.min.mjs": "sha384-8b+YfnUy2SSUYxWNbgXoICpDNcjgwQn1Tq9lPEwmPOzSEb25gBL/DQrfgwV146mq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.438.0/LICENSE
```

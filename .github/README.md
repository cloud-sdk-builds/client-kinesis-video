...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.33.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.33.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7ARDs3xLkwwy4/9+QbNU1vceUsf6fRjHBMOUD0k/b6lLuVAVS4XLJ1tdTOm+Aule
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.33.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.33.0/index.min.mjs": "sha384-7ARDs3xLkwwy4/9+QbNU1vceUsf6fRjHBMOUD0k/b6lLuVAVS4XLJ1tdTOm+Aule"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.33.0/LICENSE
```

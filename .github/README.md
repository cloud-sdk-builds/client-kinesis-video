...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.36.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.36.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-dnpm/RPEe4yQPer2PXY7/xgGhrRnQJUyRroCLVcM6K4N3RXyIQwUqNUEhbrPHxbj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.36.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.36.1/index.min.mjs": "sha384-dnpm/RPEe4yQPer2PXY7/xgGhrRnQJUyRroCLVcM6K4N3RXyIQwUqNUEhbrPHxbj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.36.1/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.41.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.41.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QlSvhPhyoyTFc/8vLtll/e2EpKhcxl5XSZMU+V5eeYxLKRxp2K6s5TnT+CYlSU2j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.41.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.41.0/index.min.mjs": "sha384-QlSvhPhyoyTFc/8vLtll/e2EpKhcxl5XSZMU+V5eeYxLKRxp2K6s5TnT+CYlSU2j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.41.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xWmdFmCeoNQqn27GJNbCTNZE+xHHNlwoJgl65j19Z3b81yScdRcBPlthMab06ibh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.687.0/index.min.mjs": "sha384-xWmdFmCeoNQqn27GJNbCTNZE+xHHNlwoJgl65j19Z3b81yScdRcBPlthMab06ibh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.687.0/LICENSE
```

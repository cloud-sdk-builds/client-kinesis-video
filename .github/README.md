...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.82.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.82.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SS2vXN+VJjdUw9AslXhoheA4q/dubwLlzzYLG4ofi8Zo7CyCTCWpWLxVYIydp/3r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.82.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.82.0/index.min.mjs": "sha384-SS2vXN+VJjdUw9AslXhoheA4q/dubwLlzzYLG4ofi8Zo7CyCTCWpWLxVYIydp/3r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.82.0/LICENSE
```

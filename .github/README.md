...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lv8ULzS9+/XbRS9enFp9phDogKLrej1Zcj0w5vV7xGD+jJgHBKn1VcATWiIGTgiI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.882.0/index.min.mjs": "sha384-lv8ULzS9+/XbRS9enFp9phDogKLrej1Zcj0w5vV7xGD+jJgHBKn1VcATWiIGTgiI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.882.0/LICENSE
```

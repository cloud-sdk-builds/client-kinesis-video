...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZT6xiRnnu7HJ2CMEXsaBDGfPC84rdIgKRww0JFL9V6ToOuiGbBDon+Q3y8BSnzGH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.933.0/index.min.mjs": "sha384-ZT6xiRnnu7HJ2CMEXsaBDGfPC84rdIgKRww0JFL9V6ToOuiGbBDon+Q3y8BSnzGH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.933.0/LICENSE
```

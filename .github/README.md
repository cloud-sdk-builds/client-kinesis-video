...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.417.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.417.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tSW/aFkjCHHgWOOaxamR42bLZNTRyG1i/cHEkSOAmDc8NZFNy0L29cgQwC3mdMRm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.417.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.417.0/index.min.mjs": "sha384-tSW/aFkjCHHgWOOaxamR42bLZNTRyG1i/cHEkSOAmDc8NZFNy0L29cgQwC3mdMRm"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.417.0`)
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.417.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.654.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.654.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HpkfqdJLpZri7rnxwrJa0cbOy9RNuAuDlRbJ6XnKy63I73fhZi+v6osL8cEHzYs7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.654.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.654.0/index.min.mjs": "sha384-HpkfqdJLpZri7rnxwrJa0cbOy9RNuAuDlRbJ6XnKy63I73fhZi+v6osL8cEHzYs7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.654.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.215.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.215.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TLtQvLV62B1Mbgt9IhY+7jkn9xDa7eOOEpulXwbRJc6iC5jNqQwqERA9TH3irYV9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.215.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.215.0/index.min.mjs": "sha384-TLtQvLV62B1Mbgt9IhY+7jkn9xDa7eOOEpulXwbRJc6iC5jNqQwqERA9TH3irYV9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.215.0/LICENSE
```

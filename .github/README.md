...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.179.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.179.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a7mOxBH7Jmk4m7dt+r6GMj8pWQYnaVDISpp7Slq2ktw3/EX63VxRUy8eFZcYKg1C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.179.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.179.0/index.min.mjs": "sha384-a7mOxBH7Jmk4m7dt+r6GMj8pWQYnaVDISpp7Slq2ktw3/EX63VxRUy8eFZcYKg1C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.179.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DxB3Dz4MPyrnc1vLlASZ1QPVEX7TMx1bd1opvobV6C7NXWHYTmMV4BkmdQxrEHhj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.796.0/index.min.mjs": "sha384-DxB3Dz4MPyrnc1vLlASZ1QPVEX7TMx1bd1opvobV6C7NXWHYTmMV4BkmdQxrEHhj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.796.0/LICENSE
```

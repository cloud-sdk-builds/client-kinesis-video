...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ucStrtGVfLL7CX67RGJbMsFMYSQ4qkMDdhUL6T1h3/TIcEIh3X4PoBdbD5tBMKPx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.649.0/index.min.mjs": "sha384-ucStrtGVfLL7CX67RGJbMsFMYSQ4qkMDdhUL6T1h3/TIcEIh3X4PoBdbD5tBMKPx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.649.0/LICENSE
```

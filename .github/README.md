...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.350.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.350.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3crB2PQCd4MDkG+E8B5EK4VQ2cMHRHxVhUs4As4oPnLUEVryJdqyCluNKzGegfRc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.350.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.350.0/index.min.mjs": "sha384-3crB2PQCd4MDkG+E8B5EK4VQ2cMHRHxVhUs4As4oPnLUEVryJdqyCluNKzGegfRc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.350.0/LICENSE
```

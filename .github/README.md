...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.43.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.43.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9Pwx4DyMLIltX8TLjwCBGMXtx/Fa8b2pLV16/jBaG8WrL7QkemPOmRca0Ht9qVFm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.43.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.43.0/index.min.mjs": "sha384-9Pwx4DyMLIltX8TLjwCBGMXtx/Fa8b2pLV16/jBaG8WrL7QkemPOmRca0Ht9qVFm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.43.0/LICENSE
```

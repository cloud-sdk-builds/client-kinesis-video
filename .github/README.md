...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.353.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.353.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5hzZyOHbHc+Za8QgprqiixbnY9lcFxExSWgkfICbniCig+v0/BX2tZC0+TnY6rDx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.353.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.353.0/index.min.mjs": "sha384-5hzZyOHbHc+Za8QgprqiixbnY9lcFxExSWgkfICbniCig+v0/BX2tZC0+TnY6rDx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.353.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.549.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.549.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-znHM6LDPFZSOo6rwqfsb6GQQsiYHtpvn3vwXfgoU3EKChT2nbLKIOUpgMMw7Yp8w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.549.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.549.0/index.min.mjs": "sha384-znHM6LDPFZSOo6rwqfsb6GQQsiYHtpvn3vwXfgoU3EKChT2nbLKIOUpgMMw7Yp8w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.549.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/Uhld+d3rZ0dEXZw/uTHw5T+twPD1n6DDjZ4/ZhMy+G4t/ChwtIBseqKXaPKFBZw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.723.0/index.min.mjs": "sha384-/Uhld+d3rZ0dEXZw/uTHw5T+twPD1n6DDjZ4/ZhMy+G4t/ChwtIBseqKXaPKFBZw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.723.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.296.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.296.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SETSHNuoYGD3+9YcESxCQg6iPfTYdblyeI4ehe83Re7VTu74j66cQWZGfRAVCSn8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.296.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.296.0/index.min.mjs": "sha384-SETSHNuoYGD3+9YcESxCQg6iPfTYdblyeI4ehe83Re7VTu74j66cQWZGfRAVCSn8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.296.0/LICENSE
```

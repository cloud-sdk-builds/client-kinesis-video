...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.4.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.4.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-onnpPImxIvAQ92fPk6BFxJ7KG5zkxt2Hk5YAX6livzVGuOrQBFNb9xskfDNHeDhH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.4.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.4.0/index.min.mjs": "sha384-onnpPImxIvAQ92fPk6BFxJ7KG5zkxt2Hk5YAX6livzVGuOrQBFNb9xskfDNHeDhH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.4.0/LICENSE
```

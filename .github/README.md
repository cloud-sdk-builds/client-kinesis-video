...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.395.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.395.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-moZsxukBOXWRdeNo9V80DS0w9owBhqf3910pcbMcp3tccMrp3Hd6xhZZR2lkoALS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.395.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.395.0/index.min.mjs": "sha384-moZsxukBOXWRdeNo9V80DS0w9owBhqf3910pcbMcp3tccMrp3Hd6xhZZR2lkoALS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.395.0/LICENSE
```

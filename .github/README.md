...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.83.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.83.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-INE2naz9fFyqkBuewPQ7U8iLrdpoapuqWuQ3pr4O056VlVmf2sOf+dExUn7E077i
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.83.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.83.0/index.min.mjs": "sha384-INE2naz9fFyqkBuewPQ7U8iLrdpoapuqWuQ3pr4O056VlVmf2sOf+dExUn7E077i"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.83.0`)
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.83.0/LICENSE
```

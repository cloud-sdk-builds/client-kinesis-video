...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.473.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.473.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l9Sogbb2hn3JrBQY4XpmAxF/O0VGqC6rHcv5Vwlv2Mo5EGAnSguM/eAP7fhP7wu2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.473.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.473.0/index.min.mjs": "sha384-l9Sogbb2hn3JrBQY4XpmAxF/O0VGqC6rHcv5Vwlv2Mo5EGAnSguM/eAP7fhP7wu2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.473.0/LICENSE
```

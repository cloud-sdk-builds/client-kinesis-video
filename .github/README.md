...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.40.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.40.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DAqq48ewC+0xNdcDqmbGPiNqxD4ZE0OJ3SUzt2gUKdp8iMrXjJ4oFtJYkcGCnIqM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.40.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.40.0/index.min.mjs": "sha384-DAqq48ewC+0xNdcDqmbGPiNqxD4ZE0OJ3SUzt2gUKdp8iMrXjJ4oFtJYkcGCnIqM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.40.0/LICENSE
```

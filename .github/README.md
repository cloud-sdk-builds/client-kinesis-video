...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.907.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.907.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tdnevS3+WsQ7K2tCaXyrQ+r1JhxN6ECCq1+M4+VUvoein/M+MmWHM8sYAtWybsiC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.907.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.907.0/index.min.mjs": "sha384-tdnevS3+WsQ7K2tCaXyrQ+r1JhxN6ECCq1+M4+VUvoein/M+MmWHM8sYAtWybsiC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.907.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.955.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.955.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SS0y2WHVreMKEFhEi01nNvOrHlKV9vXhPki8WR/lu+Z0RFU5SJ3fDADKY5gmDtXR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.955.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.955.0/index.min.mjs": "sha384-SS0y2WHVreMKEFhEi01nNvOrHlKV9vXhPki8WR/lu+Z0RFU5SJ3fDADKY5gmDtXR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.955.0/LICENSE
```

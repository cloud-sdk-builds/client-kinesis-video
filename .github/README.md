...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.271.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.271.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kXwWMWDvfvHQv93/nnxvs3Ew8EFqhKbli5qZnHvC/24GOu4cphdR8Aw5ypAecJhx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.271.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.271.0/index.min.mjs": "sha384-kXwWMWDvfvHQv93/nnxvs3Ew8EFqhKbli5qZnHvC/24GOu4cphdR8Aw5ypAecJhx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.271.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TbqJmxkp/O0e8abZpZn6hhv/uRwc3g9+4QlkQ+fLT0Zf/Kzah4BialgMNdyCWf3n
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.224.0/index.min.mjs": "sha384-TbqJmxkp/O0e8abZpZn6hhv/uRwc3g9+4QlkQ+fLT0Zf/Kzah4BialgMNdyCWf3n"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.224.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.360.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.360.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j2WPcEujVVlAOgxtW7xXQTFzKGuVws+g4/DnFngMYsc/fYyBsfVYbhM+4e/LZfIX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.360.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.360.0/index.min.mjs": "sha384-j2WPcEujVVlAOgxtW7xXQTFzKGuVws+g4/DnFngMYsc/fYyBsfVYbhM+4e/LZfIX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.360.0/LICENSE
```

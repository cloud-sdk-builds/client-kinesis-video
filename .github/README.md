...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.576.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.576.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Y/cci94qBKNQB2gSlVEAXHefGS8vCI6cPx4tWbrzkdgKDHlTM3i4x62RaOFSLhqp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.576.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.576.0/index.min.mjs": "sha384-Y/cci94qBKNQB2gSlVEAXHefGS8vCI6cPx4tWbrzkdgKDHlTM3i4x62RaOFSLhqp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.576.0/LICENSE
```

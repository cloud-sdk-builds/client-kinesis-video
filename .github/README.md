...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.535.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.535.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VCXObtFU+ZDgKv9LxJ3r6vBinsBydt4dNgATicPJPjnsPIIE8vlNuwYS/69abnaU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.535.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.535.0/index.min.mjs": "sha384-VCXObtFU+ZDgKv9LxJ3r6vBinsBydt4dNgATicPJPjnsPIIE8vlNuwYS/69abnaU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.535.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.99.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.99.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cad9RGkCow4mOfUqHwY+poOO9t7ouemAPMlS7bYDCAu/ROUm2OYDnu3/xsYopX00
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.99.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.99.0/index.min.mjs": "sha384-cad9RGkCow4mOfUqHwY+poOO9t7ouemAPMlS7bYDCAu/ROUm2OYDnu3/xsYopX00"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.99.0/LICENSE
```

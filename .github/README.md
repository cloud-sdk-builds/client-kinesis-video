...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.574.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.574.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T0rwuuwxGrRaq6B8WDFm20Z7Xn6YtqO2x64IjkuW4qC+UvVri1mV5thnc2l18tO5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.574.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.574.0/index.min.mjs": "sha384-T0rwuuwxGrRaq6B8WDFm20Z7Xn6YtqO2x64IjkuW4qC+UvVri1mV5thnc2l18tO5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.574.0/LICENSE
```

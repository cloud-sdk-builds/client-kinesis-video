...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.348.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.348.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9MFD8lkUZUa6YH/haKv/nwbx9YKSa0Xg2tVWwLl+cHtmYybaBaSQbFOdrCsRY4p9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.348.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.348.0/index.min.mjs": "sha384-9MFD8lkUZUa6YH/haKv/nwbx9YKSa0Xg2tVWwLl+cHtmYybaBaSQbFOdrCsRY4p9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.348.0/LICENSE
```

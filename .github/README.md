...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.454.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.454.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wwNOmEAHU+qBZB11ih2vP7T3/HF2Jqp0LkNKqjtxqZlmbjBYODaDbCVwjlfMpv7P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.454.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.454.0/index.min.mjs": "sha384-wwNOmEAHU+qBZB11ih2vP7T3/HF2Jqp0LkNKqjtxqZlmbjBYODaDbCVwjlfMpv7P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.454.0/LICENSE
```

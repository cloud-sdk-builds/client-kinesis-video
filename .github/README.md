...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5bnX3B+LDA/uDJm7MPlEbL1MQJhzv3wfw8nsT8svvLIXu7T+Z63sw/s+fjPWY4Ne
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.525.0/index.min.mjs": "sha384-5bnX3B+LDA/uDJm7MPlEbL1MQJhzv3wfw8nsT8svvLIXu7T+Z63sw/s+fjPWY4Ne"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.525.0/LICENSE
```

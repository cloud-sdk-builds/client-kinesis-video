...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.563.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.563.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZjC4FT+Rm2AnpWRHQy8kKMucW2iFRFA6P/Thon/Wuv0NiUHUVsHw5fIxMZnY7X/9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.563.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.563.0/index.min.mjs": "sha384-ZjC4FT+Rm2AnpWRHQy8kKMucW2iFRFA6P/Thon/Wuv0NiUHUVsHw5fIxMZnY7X/9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.563.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YKb/kOyuPqVOz3tg4AgK3akWoNl/DjbM8FJfEntXT2oVSbUZZm5projBXgUKROA2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.624.0/index.min.mjs": "sha384-YKb/kOyuPqVOz3tg4AgK3akWoNl/DjbM8FJfEntXT2oVSbUZZm5projBXgUKROA2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.624.0/LICENSE
```

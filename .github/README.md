...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.891.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.891.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QyRmXqdLgSFuXbhlFX8e7K0cyxDJK998Y0V6BNg5DcxOBT7TKfVqVw/Bx2OusbnA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.891.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.891.0/index.min.mjs": "sha384-QyRmXqdLgSFuXbhlFX8e7K0cyxDJK998Y0V6BNg5DcxOBT7TKfVqVw/Bx2OusbnA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.891.0/LICENSE
```

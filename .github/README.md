...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.514.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.514.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VLNP8ogMAOU7JezLKHeNC/MyhkqCg17jw5pHGUiLgL11Z3zXNEz5tR+htkilI3r9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.514.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.514.0/index.min.mjs": "sha384-VLNP8ogMAOU7JezLKHeNC/MyhkqCg17jw5pHGUiLgL11Z3zXNEz5tR+htkilI3r9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.514.0/LICENSE
```

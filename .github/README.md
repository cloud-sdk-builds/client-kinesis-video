...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.299.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.299.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eHNNI3I1IYtxFE3k1cPIooX2RtjSlQ3imaGe+LZtzXq8HlF6lfe+yyMB/d8wqlv5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.299.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.299.0/index.min.mjs": "sha384-eHNNI3I1IYtxFE3k1cPIooX2RtjSlQ3imaGe+LZtzXq8HlF6lfe+yyMB/d8wqlv5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.299.0/LICENSE
```

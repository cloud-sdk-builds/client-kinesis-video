...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qDUIIstT1DRfUvbcAwFImWVhbk+Z+9a/CtBhyiBPC5RxHOhFKRd1DmOj9pH9EnCK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.388.0/index.min.mjs": "sha384-qDUIIstT1DRfUvbcAwFImWVhbk+Z+9a/CtBhyiBPC5RxHOhFKRd1DmOj9pH9EnCK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.388.0/LICENSE
```

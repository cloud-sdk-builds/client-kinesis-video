...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-P2xv0hy+aCOXY+u9iySSsHPu09fF7j/Km4wOKE8A1c4HGCHbqWcFe/TShiSrgIsC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.890.0/index.min.mjs": "sha384-P2xv0hy+aCOXY+u9iySSsHPu09fF7j/Km4wOKE8A1c4HGCHbqWcFe/TShiSrgIsC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.890.0/LICENSE
```

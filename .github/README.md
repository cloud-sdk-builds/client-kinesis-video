...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8Y2LV2utDYQ8hYMNQpecHk3HGcEVCwJfjTZTZIjH1GVsAsNmsLrcXvBkZi4SObqL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.968.0/index.min.mjs": "sha384-8Y2LV2utDYQ8hYMNQpecHk3HGcEVCwJfjTZTZIjH1GVsAsNmsLrcXvBkZi4SObqL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.968.0/LICENSE
```

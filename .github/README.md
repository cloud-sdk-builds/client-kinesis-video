...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.845.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.845.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QxnoArPtgTuH3pPSDkgZv5HjJWSG3fHA+IexvOMnCnsCA9O7jz4I9MIgkZ7iZhfL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.845.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.845.0/index.min.mjs": "sha384-QxnoArPtgTuH3pPSDkgZv5HjJWSG3fHA+IexvOMnCnsCA9O7jz4I9MIgkZ7iZhfL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.845.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kWcvRSlK9mSEnx5O6C2/+zZiaOWm57T42tfzsOUltAQhYZE09KLbVO+mlFdHhXqV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.168.0/index.min.mjs": "sha384-kWcvRSlK9mSEnx5O6C2/+zZiaOWm57T42tfzsOUltAQhYZE09KLbVO+mlFdHhXqV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.168.0/LICENSE
```

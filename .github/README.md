...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vPqfSUa8pEftMqGjm7/SxqWdeQTSVQt7al0wdazJ593w9mzpJTPnqUF9s5UtUz+E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.995.0/index.min.mjs": "sha384-vPqfSUa8pEftMqGjm7/SxqWdeQTSVQt7al0wdazJ593w9mzpJTPnqUF9s5UtUz+E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.995.0/LICENSE
```

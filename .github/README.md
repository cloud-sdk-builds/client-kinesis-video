...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.587.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.587.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LCXVh/34tu43eIqjtBPOGBZoYuA+OsziByaBh3dx6f5MA29/Rg4xZG7lbrXNyNW2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.587.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.587.0/index.min.mjs": "sha384-LCXVh/34tu43eIqjtBPOGBZoYuA+OsziByaBh3dx6f5MA29/Rg4xZG7lbrXNyNW2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.587.0/LICENSE
```

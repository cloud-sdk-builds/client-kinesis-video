...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R+eLu0vWpv1wTf4hN9vGZUGrDQJhNkW2lacBFbEzDi4jhATzpml7T6zOpE+WZgtR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.504.0/index.min.mjs": "sha384-R+eLu0vWpv1wTf4hN9vGZUGrDQJhNkW2lacBFbEzDi4jhATzpml7T6zOpE+WZgtR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.504.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.35.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.35.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/Xj4hEYKP4MrsLBrUHAa0vH7AMlPgnpDdc0MaWyyPvVUNtQ5hsta550Mhc/t5xTt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.35.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.35.0/index.min.mjs": "sha384-/Xj4hEYKP4MrsLBrUHAa0vH7AMlPgnpDdc0MaWyyPvVUNtQ5hsta550Mhc/t5xTt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.35.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qsfMwFeEpa0k2AYrSRaTn2rS8b2agLh9eszRdlx/dfdYKhI8mlH0eNLXDYYeZfym
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.972.0/index.min.mjs": "sha384-qsfMwFeEpa0k2AYrSRaTn2rS8b2agLh9eszRdlx/dfdYKhI8mlH0eNLXDYYeZfym"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.972.0/LICENSE
```

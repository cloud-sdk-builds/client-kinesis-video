...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.259.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.259.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pFhRREpHWgBHT77yj7AmqiU/qnX9LktOTtZjnQ2nlYbnJNC3B+5Un0xdqqI2uV9J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.259.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.259.0/index.min.mjs": "sha384-pFhRREpHWgBHT77yj7AmqiU/qnX9LktOTtZjnQ2nlYbnJNC3B+5Un0xdqqI2uV9J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.259.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.774.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.774.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VFXHKQT/tywhhvU+KWkLpXljwez7aGUBuZUv7chmJ2+gGtWYnj5UhJk0bCWrpyur
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.774.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.774.0/index.min.mjs": "sha384-VFXHKQT/tywhhvU+KWkLpXljwez7aGUBuZUv7chmJ2+gGtWYnj5UhJk0bCWrpyur"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.774.0/LICENSE
```

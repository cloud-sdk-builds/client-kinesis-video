...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.501.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.501.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4i8FmA+wIzSLwl74j7CAu2AxTtEt5N6P3zM3eGhVogZlSx0NjRIcLGRNtSeeq5UO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.501.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.501.0/index.min.mjs": "sha384-4i8FmA+wIzSLwl74j7CAu2AxTtEt5N6P3zM3eGhVogZlSx0NjRIcLGRNtSeeq5UO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.501.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.468.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.468.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MtlrSJ8kni9vEpUOodgNwgoyBp3mI2keZ7QG2qRLOmRwA/xkjLC3pxDN+R4gx0BF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.468.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.468.0/index.min.mjs": "sha384-MtlrSJ8kni9vEpUOodgNwgoyBp3mI2keZ7QG2qRLOmRwA/xkjLC3pxDN+R4gx0BF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.468.0/LICENSE
```

...
[`@aws-sdk/client-kinesis-video`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video/v/3.181.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.181.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fjfOH9289F9/v/7rEQBvVGmTTPaYFD+9HH74Hn4JAaZairIzoq1i4wMpSt1wGaQD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.181.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video@3.181.0/index.min.mjs": "sha384-fjfOH9289F9/v/7rEQBvVGmTTPaYFD+9HH74Hn4JAaZairIzoq1i4wMpSt1wGaQD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video/blob/refs/tags/3.181.0/LICENSE
```
